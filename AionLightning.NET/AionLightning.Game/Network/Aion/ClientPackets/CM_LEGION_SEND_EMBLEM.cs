...
/// <summary>Client requests another legion's emblem image. Opcode 0xCD.</summary>
public sealed class CM_LEGION_SEND_EMBLEM : AionClientPacket
{
    ...
    public CM_LEGION_SEND_EMBLEM(GsClientConnection conn, LegionService legionService)
    {
        _conn          = conn;
    ...
    public override async ValueTask RunAsync(CancellationToken ct)
    {
        ...
        // Only DEFAULT emblems are supported (no custom emblem data transfer)
        if (legion.EmblemType != 0) return;
