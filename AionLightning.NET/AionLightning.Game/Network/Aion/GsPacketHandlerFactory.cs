    ...
    public AionClientPacket? Resolve(ushort opcode, GsClientConnection.AionState state, GsClientConnection conn)
    {
        return state switch
        {
            ...
            GsClientConnection.AionState.IN_GAME => opcode switch
            {
                ...
                0xE2  => new CM_ATTACK(conn, _world, _connRegistry, _expService, _spawnService, _lootService, _questService, _duelService, _playerDao, _rates),
                0xE3  => new CM_CASTSPELL(conn, _world, _connRegistry, _dataManager, _expService, _spawnService, _lootService, _questService, _duelService, _playerDao, _rates),
                ...
                0x114 => new CM_DIALOG_SELECT(conn, _world, _dataManager, _questDao, _itemDao, _playerDao, _mailDao, _skillDao, _expService, _connRegistry, _rates, _loggerFactory.CreateLogger<CM_DIALOG_SELECT>()),
                ...
                0x12F => new CM_CRAFT(conn, _itemDao, _dataManager, _connRegistry, _expService, _skillDao),
