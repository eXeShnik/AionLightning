    ...
    public AionClientPacket? Resolve(ushort opcode, GsClientConnection.AionState state, GsClientConnection conn)
    {
        return state switch
        {
            ...
            GsClientConnection.AionState.IN_GAME => opcode switch
            {
                ...
                0x114 => new CM_DIALOG_SELECT(conn, _world, _dataManager, _questDao, _itemDao, _playerDao, _mailDao, _expService, _connRegistry, _rates, _loggerFactory.CreateLogger<CM_DIALOG_SELECT>()),
