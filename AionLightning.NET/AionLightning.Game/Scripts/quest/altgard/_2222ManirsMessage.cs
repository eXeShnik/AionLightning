// Port of Java data/scripts/system/handlers/quest/altgard/_2222ManirsMessage.java (MrPoke).
// Talk to Manir (203607), deliver the message to 203609, turn in at 203631.
using System.Linq;
...
public sealed class _2222ManirsMessage : QuestHandlerBase
{
    private const int QuestIdConst = 2222;
    private const int ManirNpc     = 203607;
    private const int RelayNpc     = 203609;
    private const int RewardNpc    = 203631;

    public _2222ManirsMessage(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
