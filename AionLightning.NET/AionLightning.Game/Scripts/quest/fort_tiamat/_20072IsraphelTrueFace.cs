// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_20072IsraphelTrueFace.java (Cheatkiller).
// Asmodian counterpart of _10072 (world 300500000 instance): 205617 start; once 3x 182213251 collected,
// CHECK advances var1->2; SETPRO3 enters instance 300500000 (spawns 701503 + 800365, removes 182213250);
// talk 800365 (movie 495) -> talk 205579 (SET_SUCCEED). Turn in at 205617.
...
public sealed class _20072IsraphelTrueFace : QuestHandlerBase
{
    private const int QuestIdConst = 20072;
    private const int InstanceWorldId = 300500000;
    private const int CollectItem = 182213251;
    private const int RemoveItem  = 182213250;

    private readonly IItemDao _itemDao;

    public _20072IsraphelTrueFace(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnLevelUpAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnLvlUpEventAsync(env, conn, precedingQuestId: 20071, ct);
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        {
            if (targetId != 205617) return false;
