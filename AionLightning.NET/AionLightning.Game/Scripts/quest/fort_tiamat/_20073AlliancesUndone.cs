// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_20073AlliancesUndone.java (Cheatkiller).
// Asmodian mirror of _10073ShatteredAlliance: 798800 (var0->1, gives item 182213252) -> item
// 182213252 used (OnItemUse, var1->2) -> 798800 again (var2->3, gives items 182213253/182213254)
// -> 205579 (var3->5, removes both) -> 205987 (var5->6) -> kill any of 4 beasts
// (218253/218333/218421/218464) while var0==6, tracking one flag var per beast (var1..4); once 3
// distinct beasts are down, var0->7 -> 205579 (var7->8) -> 798800 (var8->9, reward). Turn in at
// 203550.
...
// Ported as-is (not a guarded give): Java calls giveQuestItem for 182213252/253/254 without
...
// Caveat: onLvlUpEvent gates this quest behind quest 20072 (_20072IsraphelTrueFace), skipped in
...
public sealed class _20073AlliancesUndone : QuestHandlerBase
{
    private const int QuestIdConst = 20073;
    private const int HubNpc       = 798800;
    private const int MidNpc       = 205579;
    private const int ReportNpc    = 205987;
    private const int RewardNpc    = 203550;
    private const int TrackingItem = 182213252;
    private const int PieceItem1   = 182213253;
    private const int PieceItem2   = 182213254;

    private static readonly int[] Beasts = [218253, 218333, 218421, 218464];

    private readonly IItemDao _itemDao;

    public _20073AlliancesUndone(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnLevelUpAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnLvlUpEventAsync(env, conn, precedingQuestId: 20072, ct);
