// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_10071OnTheTrailOfIsraphel.java (Cheatkiller).
// Elyos hub chain: 205579 (var0->1) -> 205535 (var1->2, gives item 182213242) -> 205987 (var2->3,
// removes 182213242; var4->5; var5->6 reward, gives item 182213243) -> Mysterious Orb 730465
// (USE_OBJECT, var3->4). Turn in back at 205535.
...
// Caveat: onLvlUpEvent gates this quest behind quest 10070 (_10070KaisinelsCommand), skipped in
...
public sealed class _10071OnTheTrailOfIsraphel : QuestHandlerBase
{
    private const int QuestIdConst = 10071;
    private const int StartNpc     = 205579;
    private const int ItemNpc      = 205535;
    private const int HubNpc       = 205987;
    private const int OrbNpc       = 730465;
    private const int TokenItem    = 182213242;
    private const int RewardItem   = 182213243;

    private readonly IItemDao _itemDao;

    public _10071OnTheTrailOfIsraphel(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnLevelUpAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnLvlUpEventAsync(env, conn, precedingQuestId: 10070, ct);
