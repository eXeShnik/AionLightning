// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_30700RaceForTheRelics.java (Cheatkiller).
// Dredgion Control Center campaign quest. Start at 205842 (page 4762); on entering the dredgion world
// (300510000) var 0 -> 1, kill a Relic Guard (219400) 1->2, entering the DREDGION_CONTROL_CENTER_2 zone
// 2->3, talk to 800368 (SETPRO4) 3->4, kill 219406 4->5, use 800338 (SET_SUCCEED) 5->6 REWARD; turn in
// at 205842. Leaving the dredgion world with var >= 1 resets progress back to var 0 = 1.
// note: Java's onEnterWorld reset also shows SM_SYSTEM_MESSAGE(QUEST_FAILED_$1, questName); no matching
// SM_SYSTEM_MESSAGE factory is exposed in this port (see sarpan/_21506This_End_Up), so the toast is
// dropped while the state reset is preserved.
...
public sealed class _30700RaceForTheRelics : QuestHandlerBase
{
    private const int QuestIdConst    = 30700;
    ...
    public _30700RaceForTheRelics(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
