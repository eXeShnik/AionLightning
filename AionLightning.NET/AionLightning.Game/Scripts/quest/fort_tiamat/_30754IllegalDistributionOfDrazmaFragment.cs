// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_30754IllegalDistributionOfDrazmaFragment.java (Cheatkiller).
// Asmodian mirror of _30704BlackMarketDrazma, offered from 205864 instead of 205842: accept (page
// 1011); 205889 (var0->1); 205885 (var1->2); 799436 (var2->3, straight to REWARD). Turn in back at
// 205889.
...
public sealed class _30754IllegalDistributionOfDrazmaFragment : QuestHandlerBase
{
    private const int QuestIdConst = 30754;
    private const int StartNpc     = 205864;
    private const int FirstNpc     = 205889;
    private const int SecondNpc    = 205885;
    private const int ThirdNpc     = 799436;

    public _30754IllegalDistributionOfDrazmaFragment(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
