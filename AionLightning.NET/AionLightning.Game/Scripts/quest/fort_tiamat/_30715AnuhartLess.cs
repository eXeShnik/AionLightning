// Port of Java data/scripts/system/handlers/quest/fort_tiamat/_30715AnuhartLess.java (Cheatkiller).
// Accept at 800068 (page 1011, Java sendQuestStartDialog(env, 1073741824) — the packed quest-var
// int 1073741824 = 64^5, i.e. "var slot 5 = 1" on start; ported as an explicit var-5 flag — see
// _30702DredgionControlCenterAssault's header for the full packed-int note). 205825 (sets var slot
// 5 to 2, an alternate-branch marker never read again in this file) and 205844 (resets all vars
// back to 0, undoing that marker) can be visited in either order; kill 214904 once while var0==0
// -> reward. Turn in at 800068.
...
public sealed class _30715AnuhartLess : QuestHandlerBase
{
    private const int QuestIdConst = 30715;
    private const int StartNpc     = 800068;
    private const int FirstNpc     = 205825;
    private const int SecondNpc    = 205844;
    private const int KillNpc      = 214904;

    public _30715AnuhartLess(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
