// Port of Java data/scripts/system/handlers/quest/orichalcum_key/_37103CamoAndCarnage.java (Cheatkiller).
// Accepted directly (targetId 0, QUEST_ACCEPT_1) - no NPC quest-offer dialog. Kill Camouflaged mob
// (217169) five times (var 0 -> 5); turn in at CamoAndCarnage (799906): var == 5 shows page 1352,
...
// _4077PorgusRoundup/_30455JurdinsRelease) and spawns 217169 at its spot for the mentee to kill; the
...
public sealed class _37103CamoAndCarnage : QuestHandlerBase
{
    private const int QuestIdConst = 37103;
    private const int TalkNpc      = 700968;
    private const int TurnInNpc    = 799906;
    private const int MobNpc       = 217169;

    public _37103CamoAndCarnage(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
