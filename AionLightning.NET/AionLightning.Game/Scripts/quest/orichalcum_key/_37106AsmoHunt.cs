// Port of Java data/scripts/system/handlers/quest/orichalcum_key/_37106AsmoHunt.java (Cheatkiller).
// Accepted directly (targetId 0, QUEST_ACCEPT_1) - no NPC quest-offer dialog. Kill Asmodian-hunt mob
// (217171) five times (var 0 -> 5); turn in at AsmoHunt (799906): var == 5 shows page 1352,
...
// _4077PorgusRoundup/_30455JurdinsRelease) and spawns 217171 at its spot for the mentee to kill; the
...
public sealed class _37106AsmoHunt : QuestHandlerBase
{
    private const int QuestIdConst = 37106;
    private const int TalkNpc      = 700969;
    private const int TurnInNpc    = 799906;
    private const int MobNpc       = 217171;

    public _37106AsmoHunt(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
