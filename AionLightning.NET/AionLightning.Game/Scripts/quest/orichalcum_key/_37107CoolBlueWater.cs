// Port of Java data/scripts/system/handlers/quest/orichalcum_key/_37107CoolBlueWater.java (Cheatkiller).
// Killing NinjaMob (700967) drops 5x quest item 182210040 at 100% (side-quest drop, any step);
// hand it in at CoolBlueWater (799901) via CHECK_USER_HAS_QUEST_ITEM (var 0 -> 1, REWARD).
// Accepted directly (targetId 0, QUEST_ACCEPT_1) - no NPC quest-offer dialog.
// Identical structure to sibling _37100MutantNinjaIninas (same npcs, different drop item).
...
public sealed class _37107CoolBlueWater : QuestHandlerBase
{
    private const int QuestIdConst = 37107;
    private const int NinjaMobNpc  = 700967;
    private const int TurnInNpc    = 799901;
    private const int DropItem     = 182210040;

    private readonly IItemDao _itemDao;

    public _37107CoolBlueWater(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
