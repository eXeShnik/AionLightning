// Port of Java data/scripts/system/handlers/quest/beshmundir/_30248NewAethercannon.java (vlog, modified bobobear).
// Requires owning the Noble Siel's Supreme Aethercannon (101900650) to start at Gefeios (799032);
// kill any of the three Debilkarim (286904/281419/215795) while all four quest_data.xml
// collect_items (base weapon + essences 186000099/186000106/186000107) are held to consume them and
// grant the quest-work token (182213286), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30248NewAethercannon : QuestHandlerBase
{
    private const int QuestIdConst = 30248;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 101900650; // Noble Siel's Supreme Aethercannon
    private const int QuestWorkItemId  = 182213286;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30248NewAethercannon(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
