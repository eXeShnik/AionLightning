// Port of Java data/scripts/system/handlers/quest/beshmundir/_30242NewDagger.java (vlog).
// Requires owning the Noble Siel's Supreme Dagger (100200839) to start at Gefeios (799032); kill any
...
// quest-work token (182209640), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30242NewDagger : QuestHandlerBase
{
    private const int QuestIdConst = 30242;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 100200839; // Noble Siel's Supreme Dagger
    private const int QuestWorkItemId  = 182209640;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30242NewDagger(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
