// Port of Java data/scripts/system/handlers/quest/beshmundir/_30336ImprovedGreatsword.java (vlog).
// Asmodian counterpart of _30236NewGreatsword. Requires owning the Noble Siel's Supreme Greatsword
// (100900721) to start at Tataka (799336); kill any of the three Debilkarim (286904/281419/215795)
// while all four quest_data.xml collect_items (base weapon + essences 186000099/186000106/186000107)
// are held to consume them and grant the quest-work token (182209734), flipping straight to REWARD;
// turn in at Tataka.
...
public sealed class _30336ImprovedGreatsword : QuestHandlerBase
{
    private const int QuestIdConst = 30336;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 100900721; // Noble Siel's Supreme Greatsword
    private const int QuestWorkItemId  = 182209734;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30336ImprovedGreatsword(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
