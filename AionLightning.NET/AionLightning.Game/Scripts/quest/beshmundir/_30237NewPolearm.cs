// Port of Java data/scripts/system/handlers/quest/beshmundir/_30237NewPolearm.java (vlog).
// Requires owning the Noble Siel's Supreme Polearm (101300686) to start at Gefeios (799032); kill
...
// quest-work token (182209635), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30237NewPolearm : QuestHandlerBase
{
    private const int QuestIdConst = 30237;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 101300686; // Noble Siel's Supreme Polearm
    private const int QuestWorkItemId  = 182209635;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30237NewPolearm(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
