// Port of Java data/scripts/system/handlers/quest/beshmundir/_30236NewGreatsword.java (vlog).
// Requires owning the Noble Siel's Supreme Greatsword (100900716) to start at Gefeios (799032); kill
...
// quest-work token (182209634), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30236NewGreatsword : QuestHandlerBase
{
    private const int QuestIdConst = 30236;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 100900716; // Noble Siel's Supreme Greatsword
    private const int QuestWorkItemId  = 182209634;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30236NewGreatsword(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
