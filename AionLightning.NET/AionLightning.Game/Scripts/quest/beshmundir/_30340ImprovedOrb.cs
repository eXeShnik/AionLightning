// Port of Java data/scripts/system/handlers/quest/beshmundir/_30340ImprovedOrb.java (vlog).
// Asmodian counterpart of _30240NewOrb. Requires owning the Noble Siel's Supreme Orb (100500735)
...
// to consume them and grant the quest-work token (182209738), flipping straight to REWARD; turn in
// at Tataka.
...
public sealed class _30340ImprovedOrb : QuestHandlerBase
{
    private const int QuestIdConst = 30340;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 100500735; // Noble Siel's Supreme Orb
    private const int QuestWorkItemId  = 182209738;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30340ImprovedOrb(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
