// Port of Java data/scripts/system/handlers/quest/beshmundir/_30343ImprovedMace.java (vlog).
// Asmodian counterpart of _30243NewMace. Requires owning the Noble Siel's Supreme Mace (100100716)
...
// to consume them and grant the quest-work token (182209741), flipping straight to REWARD; turn in
// at Tataka.
...
public sealed class _30343ImprovedMace : QuestHandlerBase
{
    private const int QuestIdConst = 30343;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 100100716; // Noble Siel's Supreme Mace
    private const int QuestWorkItemId  = 182209741;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30343ImprovedMace(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
