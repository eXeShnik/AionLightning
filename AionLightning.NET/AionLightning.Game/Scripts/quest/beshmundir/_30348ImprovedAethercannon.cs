// Port of Java data/scripts/system/handlers/quest/beshmundir/_30348ImprovedAethercannon.java (vlog, modified bobobear).
// Asmodian counterpart of _30248NewAethercannon. Requires owning the Noble Siel's Supreme
// Aethercannon (101900655) to start at Tataka (799336); kill any of the three Debilkarim
// (286904/281419/215795) while all four quest_data.xml collect_items (base weapon + essences
// 186000099/186000106/186000107) are held to consume them and grant the quest-work token
// (182213289), flipping straight to REWARD; turn in at Tataka.
...
public sealed class _30348ImprovedAethercannon : QuestHandlerBase
{
    private const int QuestIdConst = 30348;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 101900655; // Noble Siel's Supreme Aethercannon
    private const int QuestWorkItemId  = 182213289;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30348ImprovedAethercannon(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
