// Port of Java data/scripts/system/handlers/quest/beshmundir/_30243NewMace.java (vlog).
// Requires owning the Noble Siel's Supreme Mace (100100711) to start at Gefeios (799032); kill any
...
// quest-work token (182209641), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30243NewMace : QuestHandlerBase
{
    private const int QuestIdConst = 30243;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 100100711; // Noble Siel's Supreme Mace
    private const int QuestWorkItemId  = 182209641;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30243NewMace(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
