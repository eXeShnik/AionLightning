// Port of Java data/scripts/system/handlers/quest/beshmundir/_30338ImprovedStaff.java (vlog).
// Asmodian counterpart of _30238NewStaff. Requires owning the Noble Siel's Supreme Staff
// (101500736) to start at Tataka (799336); kill any of the three Debilkarim (286904/281419/215795)
// while all four quest_data.xml collect_items (base weapon + essences 186000099/186000106/186000107)
// are held to consume them and grant the quest-work token (182209736), flipping straight to REWARD;
// turn in at Tataka.
...
public sealed class _30338ImprovedStaff : QuestHandlerBase
{
    private const int QuestIdConst = 30338;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 101500736; // Noble Siel's Supreme Staff
    private const int QuestWorkItemId  = 182209736;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30338ImprovedStaff(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
