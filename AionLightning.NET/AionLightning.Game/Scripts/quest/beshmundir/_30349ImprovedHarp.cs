// Port of Java data/scripts/system/handlers/quest/beshmundir/_30349ImprovedHarp.java (vlog, modified Bobobear).
// Asmodian counterpart of _30249NewHarp. Requires owning the Noble Siel's Supreme Harp (102000690)
// to start at Tataka (799336); kill any of the three Debilkarim (286904/281419/215795) while all
// four quest_data.xml collect_items (base weapon + essences 186000099/186000106/186000107) are held
// to consume them and grant the quest-work token (182213290), flipping straight to REWARD; turn in
// at Tataka.
...
public sealed class _30349ImprovedHarp : QuestHandlerBase
{
    private const int QuestIdConst = 30349;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 102000690; // Noble Siel's Supreme Harp
    private const int QuestWorkItemId  = 182213290;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30349ImprovedHarp(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
