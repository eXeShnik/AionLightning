// Port of Java data/scripts/system/handlers/quest/beshmundir/_30240NewOrb.java (vlog).
// Requires owning the Noble Siel's Supreme Orb (100500730) to start at Gefeios (799032); kill any
...
// quest-work token (182209638), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30240NewOrb : QuestHandlerBase
{
    private const int QuestIdConst = 30240;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 100500730; // Noble Siel's Supreme Orb
    private const int QuestWorkItemId  = 182209638;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30240NewOrb(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
