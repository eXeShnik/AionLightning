// Port of Java data/scripts/system/handlers/quest/beshmundir/_30250NewKeyBlade.java (Eloann).
// Requires owning the Noble Siel's Supreme KeyBlade (102100581) to start at Gefeios (799032); kill
...
// quest-work token (182213559), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30250NewKeyBlade : QuestHandlerBase
{
    private const int QuestIdConst = 30250;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 102100581; // Noble Siel's Supreme KeyBlade
    private const int QuestWorkItemId  = 182213559;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30250NewKeyBlade(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
