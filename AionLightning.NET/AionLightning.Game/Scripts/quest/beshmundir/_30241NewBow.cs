// Port of Java data/scripts/system/handlers/quest/beshmundir/_30241NewBow.java (vlog).
// Requires owning the Noble Siel's Supreme Bow (101700754) to start at Gefeios (799032); kill any
...
// quest-work token (182209639), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30241NewBow : QuestHandlerBase
{
    private const int QuestIdConst = 30241;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 101700754; // Noble Siel's Supreme Bow
    private const int QuestWorkItemId  = 182209639;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30241NewBow(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
