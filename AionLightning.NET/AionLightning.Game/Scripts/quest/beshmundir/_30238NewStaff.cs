// Port of Java data/scripts/system/handlers/quest/beshmundir/_30238NewStaff.java (vlog).
// Requires owning the Noble Siel's Supreme Staff (101500731) to start at Gefeios (799032); kill any
...
// quest-work token (182209636), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30238NewStaff : QuestHandlerBase
{
    private const int QuestIdConst = 30238;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 101500731; // Noble Siel's Supreme Staff
    private const int QuestWorkItemId  = 182209636;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30238NewStaff(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
