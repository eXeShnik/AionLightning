// Port of Java data/scripts/system/handlers/quest/beshmundir/_30341ImprovedBow.java (vlog).
// Asmodian counterpart of _30241NewBow. Requires owning the Noble Siel's Supreme Bow (101700759)
...
// to consume them and grant the quest-work token (182209739), flipping straight to REWARD; turn in
// at Tataka.
...
public sealed class _30341ImprovedBow : QuestHandlerBase
{
    private const int QuestIdConst = 30341;
    private const int StartNpc     = 799336; // Tataka
    private const int BaseWeaponItemId = 101700759; // Noble Siel's Supreme Bow
    private const int QuestWorkItemId  = 182209739;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30341ImprovedBow(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
