// Port of Java data/scripts/system/handlers/quest/beshmundir/_30249NewHarp.java (vlog).
// Requires owning the Noble Siel's Supreme Harp (102000685) to start at Gefeios (799032); kill any
...
// quest-work token (182213287), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30249NewHarp : QuestHandlerBase
{
    private const int QuestIdConst = 30249;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 102000685; // Noble Siel's Supreme Harp
    private const int QuestWorkItemId  = 182213287;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30249NewHarp(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
