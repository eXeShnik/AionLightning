// Port of Java data/scripts/system/handlers/quest/beshmundir/_30247NewPistol.java (vlog, modified Bobobear).
// Requires owning the Noble Siel's Supreme Pistol (101800651) to start at Gefeios (799032); kill any
...
// quest-work token (182213285), flipping straight to REWARD; turn in at Gefeios.
...
public sealed class _30247NewPistol : QuestHandlerBase
{
    private const int QuestIdConst = 30247;
    private const int StartNpc     = 799032; // Gefeios
    private const int BaseWeaponItemId = 101800651; // Noble Siel's Supreme Pistol
    private const int QuestWorkItemId  = 182213285;
    private static readonly int[] DebilkarimNpcIds = [286904, 281419, 215795];

    private readonly IItemDao _itemDao;

    public _30247NewPistol(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
