// Port of Java data/scripts/system/handlers/quest/danuar_reliquary/_16920ReliquaryReconaissance.java.
// Talk to 801543 to start; the quest flips to REWARD either by entering the sensory-area zone
// region or by moving within onAtDistance range of NPC 206325 (both while var0 is still 0). Turn in
// at 801543.
...
public sealed class _16920ReliquaryReconaissance : QuestHandlerBase
{
    private const int QuestIdConst = 16920;
    private const int StartNpc     = 801543;
    private const int SensorNpc    = 206325;
    private const string EnterZoneName = "LDF5_UNDER_SENSORYAREA_Q16920_206325_1_600070000";

    public _16920ReliquaryReconaissance(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
