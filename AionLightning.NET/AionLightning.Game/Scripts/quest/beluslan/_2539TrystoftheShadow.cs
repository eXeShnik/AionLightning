// Port of Java data/scripts/system/handlers/quest/beluslan/_2539TrystoftheShadow.java.
// Talk to 790022 to start; relay chain 204433 (var0->1), 204112 (var1->2), 204056 (var2->3); turn
// in back at 790022, which resets var to 3 on the SELECT_QUEST_REWARD click before flipping to
...
public sealed class _2539TrystoftheShadow : QuestHandlerBase
{
    private const int QuestIdConst = 2539;
    private const int StartNpc  = 790022;
    private const int Relay1Npc = 204433;
    private const int Relay2Npc = 204112;
    private const int Relay3Npc = 204056;

    public _2539TrystoftheShadow(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
