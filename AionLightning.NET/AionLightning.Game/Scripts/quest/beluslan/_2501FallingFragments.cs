// Port of Java data/scripts/system/handlers/quest/beluslan/_2501FallingFragments.java.
// Talk to 204701 to start; relay chain 204713 (var0->1), 204719 (var1->2), 204733 (var2->3); turn
// in back at 204701, which resets var to 3 on the SELECT_QUEST_REWARD click before flipping to
// REWARD (matches Java's qs.setQuestVar(3) — a whole-step reset, not a per-slot write).
...
public sealed class _2501FallingFragments : QuestHandlerBase
{
    private const int QuestIdConst = 2501;
    private const int StartNpc  = 204701;
    private const int Relay1Npc = 204713;
    private const int Relay2Npc = 204719;
    private const int Relay3Npc = 204733;

    public _2501FallingFragments(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
