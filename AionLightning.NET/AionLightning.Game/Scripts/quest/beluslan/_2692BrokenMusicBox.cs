// Port of Java data/scripts/system/handlers/quest/beluslan/_2692BrokenMusicBox.java.
// Talk to 212164 to start; relay chain 204108 (var0->1), 279027 (var1->2), 279029 (var2->3); turn
// in back at 212164, which resets var to 3 on the SELECT_QUEST_REWARD click before flipping to
...
public sealed class _2692BrokenMusicBox : QuestHandlerBase
{
    private const int QuestIdConst = 2692;
    private const int StartNpc  = 212164;
    private const int Relay1Npc = 204108;
    private const int Relay2Npc = 279027;
    private const int Relay3Npc = 279029;

    public _2692BrokenMusicBox(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
