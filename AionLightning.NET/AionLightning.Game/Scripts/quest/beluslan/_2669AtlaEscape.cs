// Port of Java data/scripts/system/handlers/quest/beluslan/_2669AtlaEscape.java (Cheatkiller).
// Accept at Atla (204815). Talking Atla again (SETPRO1) makes her follow the player to NPC 730111
// (var0 0->1); reaching there flips to REWARD (defaultFollowEndEvent 1,1,true). Report to 204777.
...
public sealed class _2669AtlaEscape : QuestHandlerBase
{
    private const int QuestIdConst = 2669;
    private const int StartNpc     = 204815;
    private const int EndNpc       = 204777;
    private const int TargetNpc    = 730111;

    public _2669AtlaEscape(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
