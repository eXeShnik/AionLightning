// Port of Java data/scripts/system/handlers/quest/tiamaranta/_10063ShotThroughTheHeart.java (vlog).
// Talk to Garnon (800018) to advance var 0->1 (SETPRO1); entering HEART_OF_PETRIFICATION_ENTRANCE
// flips 1->2; talk to Betri (800065) at var 2 to flip 2->3 (SETPRO3); use quest object 701237 at
// var 3 to receive the collect item (182212557); back at Garnon, CHECK_USER_HAS_QUEST_ITEM collects
// it and flips to REWARD; turn in at Adella (205886).
...
public sealed class _10063ShotThroughTheHeart : QuestHandlerBase
{
    private const int QuestIdConst = 10063;
    private const int GarnonNpc    = 800018;
    private const int BetriNpc     = 800065;
    private const int AdellaNpc    = 205886;
    private const int UseObjectNpc = 701237;
    private const int CollectItemId = 182212557;
    private const string HeartEntranceZone = "HEART_OF_PETRIFICATION_ENTRANCE_600030000";

    private readonly IItemDao _itemDao;

    public _10063ShotThroughTheHeart(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override void Register(QuestEngine engine)
    {
        ...
        engine.RegisterQuestNpc(BetriNpc).OnTalk.Add(QuestId);
