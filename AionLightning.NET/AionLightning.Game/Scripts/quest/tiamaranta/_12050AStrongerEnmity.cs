// Port of Java data/scripts/system/handlers/quest/tiamaranta/_12050AStrongerEnmity.java (nrg).
// Kill 10 opposing-race players at abyss rank 5 (Java AbyssRankEnum.GRADE5_SOLDIER,
// registerOnKillRanked, defaultOnKillRankedEvent(env, 0, 10, true)) to flip to REWARD; turn in at 205843.
...
// scoped to Tiamaranta's own world id (600030000, where NPC 205843 hands the quest out) and checks
...
public sealed class _12050AStrongerEnmity : QuestHandlerBase
{
    private const int QuestIdConst      = 12050;
    private const int StartNpc          = 205843;
    ...
    public _12050AStrongerEnmity(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
