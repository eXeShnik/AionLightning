// Port of Java data/scripts/system/handlers/quest/eltnen/_1483HarumonerksRequest.java (MrPoke, remod).
// Talk to 798126 to start; a 2-npc relay (203940 -> 203944) advances var 0 from 0 to 2; turn in
// at 798127.
...
public sealed class _1483HarumonerksRequest : QuestHandlerBase
{
    private const int QuestIdConst = 1483;
    private const int StartNpc     = 798126;
    private const int SecondNpc    = 203940;
    private const int ThirdNpc     = 203944;
    private const int TurnInNpc    = 798127;

    public _1483HarumonerksRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
