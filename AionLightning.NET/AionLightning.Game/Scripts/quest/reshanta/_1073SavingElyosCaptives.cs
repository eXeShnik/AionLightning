// Port of Java data/scripts/system/handlers/quest/reshanta/_1073SavingElyosCaptives.java (MetaWind/kale, reworked vlog).
// Level-up / zone-mission gated on 1701. Talk chain Sakmis (278502, var0 0->1) -> Nereus (278517,
...
// movie 270; losing the prisoner (or logging out at var0 4) reverts var0 4->3. Turn in at Nereus
...
public sealed class _1073SavingElyosCaptives : QuestHandlerBase
{
    private const int QuestIdConst = 1073;
    ...
    public _1073SavingElyosCaptives(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
