// Port of Java data/scripts/system/handlers/quest/reshanta/_2702Defeat9thRankElyosSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 1 (Java AbyssRankEnum.GRADE9_SOLDIER,
...
public sealed class _2702Defeat9thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2702;
    private const int StartNpc       = 278016;
    private const int RequiredGrade  = 1;
    private const int ReshantaWorldId = 400010000;

    public _2702Defeat9thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
