// Port of Java data/scripts/system/handlers/quest/reshanta/_1703Defeat8thRankAsmodianSoldiers.java (Hilgert/vlog).
...
public sealed class _1703Defeat8thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1703;
    private const int StartNpc       = 278503;
    private const int RequiredGrade  = 2;
    private const int ReshantaWorldId = 400010000;

    public _1703Defeat8thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
