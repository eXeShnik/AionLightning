// Port of Java data/scripts/system/handlers/quest/reshanta/_2708Defeat3thRankElyosSoldiers.java (Hilgert/vlog).
...
public sealed class _2708Defeat3thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2708;
    private const int StartNpc       = 278017;
    private const int RequiredGrade  = 7;
    private const int ReshantaWorldId = 400010000;

    public _2708Defeat3thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
