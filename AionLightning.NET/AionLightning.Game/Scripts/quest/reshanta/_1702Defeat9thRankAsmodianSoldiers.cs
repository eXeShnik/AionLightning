// Port of Java data/scripts/system/handlers/quest/reshanta/_1702Defeat9thRankAsmodianSoldiers.java (Hilgert/vlog).
...
public sealed class _1702Defeat9thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1702;
    private const int StartNpc       = 278503;
    private const int RequiredGrade  = 1;
    private const int ReshantaWorldId = 400010000;

    public _1702Defeat9thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
