// Port of Java data/scripts/system/handlers/quest/reshanta/_2719ChallengeElyosOfficers.java (vlog).
// Kill 10 opposing-race players ranked STAR1_OFFICER (Java registerOnKillRanked(STAR1_OFFICER),
// defaultOnKillRankedEvent(env, 0, 10, true)) to flip to REWARD; report to Votan (278001).
...
public sealed class _2719ChallengeElyosOfficers : QuestHandlerBase
{
    private const int QuestIdConst    = 2719;
    ...
    public _2719ChallengeElyosOfficers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
