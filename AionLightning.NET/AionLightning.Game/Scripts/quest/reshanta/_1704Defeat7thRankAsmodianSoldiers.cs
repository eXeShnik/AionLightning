// Port of Java data/scripts/system/handlers/quest/reshanta/_1704Defeat7thRankAsmodianSoldiers.java (Hilgert/vlog).
...
public sealed class _1704Defeat7thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1704;
    private const int StartNpc       = 278503;
    private const int RequiredGrade  = 3;
    private const int ReshantaWorldId = 400010000;

    public _1704Defeat7thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
