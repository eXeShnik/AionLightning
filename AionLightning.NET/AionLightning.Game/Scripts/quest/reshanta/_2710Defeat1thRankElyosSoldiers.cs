// Port of Java data/scripts/system/handlers/quest/reshanta/_2710Defeat1thRankElyosSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 9 (Java AbyssRankEnum.GRADE1_SOLDIER,
// registerOnKillRanked) anywhere in Reshanta to flip to REWARD; turn in at 278017.
...
public sealed class _2710Defeat1thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2710;
    private const int StartNpc       = 278017;
    private const int RequiredGrade  = 9;
    private const int ReshantaWorldId = 400010000;

    public _2710Defeat1thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
