// Port of Java data/scripts/system/handlers/quest/reshanta/_1854GeneralPurge.java (Luzien).
// Kill 3 opposing-race players ranked GENERAL (Java registerOnKillRanked(GENERAL),
// defaultOnKillRankedEvent(env, 0, 3, true)) to flip to REWARD; turn in at 278501.
...
public sealed class _1854GeneralPurge : QuestHandlerBase
{
    private const int QuestIdConst    = 1854;
    ...
    public _1854GeneralPurge(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
