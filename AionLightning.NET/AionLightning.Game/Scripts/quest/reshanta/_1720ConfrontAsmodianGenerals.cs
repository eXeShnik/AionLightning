// Port of Java data/scripts/system/handlers/quest/reshanta/_1720ConfrontAsmodianGenerals.java (vlog).
// [Group] Kill 3 opposing-race players ranked GENERAL (Java registerOnKillRanked(GENERAL),
// defaultOnKillRankedEvent(env, 0, 3, true)) to flip to REWARD; report to Michalis (278501).
...
public sealed class _1720ConfrontAsmodianGenerals : QuestHandlerBase
{
    private const int QuestIdConst    = 1720;
    ...
    public _1720ConfrontAsmodianGenerals(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
