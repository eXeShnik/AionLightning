// Port of Java data/scripts/system/handlers/quest/reshanta/_1708Defeat3thRankAsmodianSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 7 (Java AbyssRankEnum.GRADE3_SOLDIER,
// registerOnKillRanked) anywhere in Reshanta to flip to REWARD; turn in at 278502.
...
public sealed class _1708Defeat3thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1708;
    private const int StartNpc       = 278502;
    private const int RequiredGrade  = 7;
    private const int ReshantaWorldId = 400010000;

    public _1708Defeat3thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
