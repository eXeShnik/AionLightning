// Port of Java data/scripts/system/handlers/quest/reshanta/_2706Defeat5thRankElyosSoldiers.java (Hilgert/vlog).
...
public sealed class _2706Defeat5thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2706;
    private const int StartNpc       = 278016;
    private const int RequiredGrade  = 5;
    private const int ReshantaWorldId = 400010000;

    public _2706Defeat5thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
