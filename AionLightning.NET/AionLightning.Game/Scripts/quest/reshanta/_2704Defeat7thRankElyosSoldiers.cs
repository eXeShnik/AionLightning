// Port of Java data/scripts/system/handlers/quest/reshanta/_2704Defeat7thRankElyosSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 3 (Java AbyssRankEnum.GRADE7_SOLDIER,
// registerOnKillRanked) anywhere in Reshanta to flip to REWARD; turn in at 278016.
...
public sealed class _2704Defeat7thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2704;
    private const int StartNpc       = 278016;
    private const int RequiredGrade  = 3;
    private const int ReshantaWorldId = 400010000;

    public _2704Defeat7thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
