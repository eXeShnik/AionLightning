// Port of Java data/scripts/system/handlers/quest/reshanta/_1706Defeat5thRankAsmodianSoldiers.java (Hilgert/vlog).
...
public sealed class _1706Defeat5thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1706;
    private const int StartNpc       = 278503;
    private const int RequiredGrade  = 5;
    private const int ReshantaWorldId = 400010000;

    public _1706Defeat5thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
