// Port of Java data/scripts/system/handlers/quest/reshanta/_1709Defeat2thRankAsmodianSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 8 (Java AbyssRankEnum.GRADE2_SOLDIER,
...
public sealed class _1709Defeat2thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1709;
    private const int StartNpc       = 278502;
    private const int RequiredGrade  = 8;
    private const int ReshantaWorldId = 400010000;

    public _1709Defeat2thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
