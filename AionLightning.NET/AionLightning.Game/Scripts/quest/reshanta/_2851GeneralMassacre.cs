// Port of Java data/scripts/system/handlers/quest/reshanta/_2851GeneralMassacre.java (Luzien).
// Kill 3 opposing-race players ranked GENERAL (Java registerOnKillRanked(GENERAL),
// defaultOnKillRankedEvent(env, 0, 3, true)) to flip to REWARD; turn in at 278001.
...
public sealed class _2851GeneralMassacre : QuestHandlerBase
{
    private const int QuestIdConst    = 2851;
    ...
    public _2851GeneralMassacre(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
