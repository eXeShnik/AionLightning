// Port of Java data/scripts/system/handlers/quest/reshanta/_2709Defeat2thRankElyosSoldiers.java (Hilgert/vlog).
...
public sealed class _2709Defeat2thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2709;
    private const int StartNpc       = 278017;
    private const int RequiredGrade  = 8;
    private const int ReshantaWorldId = 400010000;

    public _2709Defeat2thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
