// Port of Java data/scripts/system/handlers/quest/reshanta/_2707Defeat4thRankElyosSoldiers.java (Hilgert/vlog).
...
public sealed class _2707Defeat4thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2707;
    private const int StartNpc       = 278017;
    private const int RequiredGrade  = 6;
    private const int ReshantaWorldId = 400010000;

    public _2707Defeat4thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
