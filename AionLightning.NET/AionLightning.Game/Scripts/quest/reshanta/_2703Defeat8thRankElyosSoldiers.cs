// Port of Java data/scripts/system/handlers/quest/reshanta/_2703Defeat8thRankElyosSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 2 (Java AbyssRankEnum.GRADE8_SOLDIER,
...
public sealed class _2703Defeat8thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2703;
    private const int StartNpc       = 278016;
    private const int RequiredGrade  = 2;
    private const int ReshantaWorldId = 400010000;

    public _2703Defeat8thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
