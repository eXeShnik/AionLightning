// Port of Java data/scripts/system/handlers/quest/reshanta/_1853OfficerOusting.java (Luzien).
// Kill 10 opposing-race players ranked STAR1_OFFICER (Java registerOnKillRanked(STAR1_OFFICER),
// defaultOnKillRankedEvent(env, 0, 10, true)) to flip to REWARD; turn in at 278501.
...
public sealed class _1853OfficerOusting : QuestHandlerBase
{
    private const int QuestIdConst    = 1853;
    ...
    public _1853OfficerOusting(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
