// Port of Java data/scripts/system/handlers/quest/reshanta/_1710Defeat1thRankAsmodianSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 9 (Java AbyssRankEnum.GRADE1_SOLDIER,
...
public sealed class _1710Defeat1thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1710;
    private const int StartNpc       = 278502;
    private const int RequiredGrade  = 9;
    private const int ReshantaWorldId = 400010000;

    public _1710Defeat1thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
