// Port of Java data/scripts/system/handlers/quest/reshanta/_2850OfficerObliteration.java (Luzien).
// Kill 10 opposing-race players ranked STAR1_OFFICER (Java registerOnKillRanked(STAR1_OFFICER),
// defaultOnKillRankedEvent(env, 0, 10, true)) to flip to REWARD; turn in at 278001.
...
public sealed class _2850OfficerObliteration : QuestHandlerBase
{
    private const int QuestIdConst    = 2850;
    ...
    public _2850OfficerObliteration(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
