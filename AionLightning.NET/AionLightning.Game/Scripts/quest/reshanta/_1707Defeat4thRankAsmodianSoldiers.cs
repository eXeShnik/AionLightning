// Port of Java data/scripts/system/handlers/quest/reshanta/_1707Defeat4thRankAsmodianSoldiers.java (Hilgert/vlog).
// Kill 10 opposing-race players at abyss rank 6 (Java AbyssRankEnum.GRADE4_SOLDIER,
...
public sealed class _1707Defeat4thRankAsmodianSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 1707;
    private const int StartNpc       = 278502;
    private const int RequiredGrade  = 6;
    private const int ReshantaWorldId = 400010000;

    public _1707Defeat4thRankAsmodianSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
