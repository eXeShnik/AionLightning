// Port of Java data/scripts/system/handlers/quest/reshanta/_3718DredgingTheDredgion.java.
// Start/relay/turn-in all at 279045. var0 gates the intro relay (0 -> SETPRO1 -> 1). var1 is a
// dredgion-run counter (0->3, one per dredgion completion); var2 is a kill counter (0->8, mob 214814).
// Turn-in opens once var1==3 && var2==8; SELECT_QUEST_REWARD then flips var0 1->1 straight to REWARD.
...
public sealed class _3718DredgingTheDredgion : QuestHandlerBase
{
    private const int QuestIdConst = 3718;
    private const int Npc          = 279045;
    private const int KillNpc      = 214814;

    public _3718DredgingTheDredgion(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
