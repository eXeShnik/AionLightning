// Port of Java data/scripts/system/handlers/quest/reshanta/_2705Defeat6thRankElyosSoldiers.java (Hilgert/vlog).
...
public sealed class _2705Defeat6thRankElyosSoldiers : QuestHandlerBase
{
    private const int QuestIdConst   = 2705;
    private const int StartNpc       = 278016;
    private const int RequiredGrade  = 4;
    private const int ReshantaWorldId = 400010000;

    public _2705Defeat6thRankElyosSoldiers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
