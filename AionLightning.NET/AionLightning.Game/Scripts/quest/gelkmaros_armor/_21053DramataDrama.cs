// Port of Java data/scripts/system/handlers/quest/gelkmaros_armor/_21053DramataDrama.java (zhkchi).
// Structurally identical to _21052DragonHuntin but at npc 799320: multi-page accept, collect
// turn-in (CHECK_USER_HAS_QUEST_ITEM -> checkQuestItems, ok 5 / fail 2716), turn in.
...
public sealed class _21053DramataDrama : QuestHandlerBase
{
    private const int QuestIdConst = 21053;
    private const int Npc          = 799320;

    private readonly IItemDao _itemDao;

    public _21053DramataDrama(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
