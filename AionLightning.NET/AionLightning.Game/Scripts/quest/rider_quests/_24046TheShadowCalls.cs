// Port of Java data/scripts/system/handlers/quest/rider_quests/_24046TheShadowCalls.java (pralinka).
// Structurally identical to reshanta/_2076TheShadowSummons (Elyos twin), rider-quest questId.
// Phyper (798300, var 0->1) -> leaving BALTASAR_HILL_VILLAGE_220050000 at var 1 gives token 182205502
// and advances (1->2) -> Khrudgelmir (204253, var 2->3, removes token at SETPRO3) -> Garm (204089,
// SETPRO4 enters Shadow Court instance 320120000, plays movie 423, 3->5) -> Underground Arena Exit
// (700369, USE_OBJECT var==5, 5->6) -> Khrudgelmir SET_SUCCEED (6 -> REWARD) -> turn in at Munin
// (203550). Dying or leaving the instance while var==5 reverts to var 3.
...
public sealed class _24046TheShadowCalls : QuestHandlerBase
{
    private const int QuestIdConst = 24046;
    ...
    public _24046TheShadowCalls(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
