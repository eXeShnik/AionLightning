// Port of Java data/scripts/system/handlers/quest/rider_quests/_24090FootstepsOfThePast.java (pralinka).
// Asmodian mirror of _14090 (Tiamaranta chain, level-up gated on 24081): Protector Oriata (802059,
// var0 0->1 giving item 182215412), then USE 182215412 inside LDF4B_ITEMUSEAREA_Q14090 to enter
// instance world 300490000 (var0 1->2); entering 300490000 at var0==2 spawns Tiamat's Remains
// (730889); USE it (var0==2) spawns Oriata of the Past (802060) and gives item 182215413 (var0 2->3);
// Oriata (802060, var0==3) enters instance world 300500000 spawning Israphel (802062) + Concentrated
// Ide Crystal (730890) (var0 3->4); Israphel (802062, var0==4, var0 4->5); USE the Ide Crystal
// (730890, var0==5) spawns Oriata of the Past (802061), gives item 182215414, flips to REWARD. Turn
// in at 802061 (movie 892, removes 182215413+182215414). Logging out at var0 <= 5 resets to var0 0.
...
// Java quirk preserved: the item-use zone name is "LDF4B_ITEMUSEAREA_Q14090" (the Elyos quest's zone
// id) verbatim from the Java source — a copy-paste that is kept as shipped.
...
public sealed class _24090FootstepsOfThePast : QuestHandlerBase
{
    private const int QuestIdConst    = 24090;
    ...
    private const int StartItem       = 182215412;
    private const int Item413         = 182215413;
    private const int Item414         = 182215414;
    ...
    public _24090FootstepsOfThePast(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnLevelUpAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnLvlUpEventAsync(env, conn, 24081, isZoneMission: true, ct);
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        if (entry.Status == QuestStatus.START)
        {
            ...
            if (targetId == TiamatRemains)
            {
                ...
                {
                    if ((player.Inventory.FindByItemId(Item413)?.Count ?? 0) == 0
                        && !await GiveQuestItemAsync(player, conn, _itemDao, Item413, 1, ct))
                        return true;
            ...
            if (targetId == IdeCrystal)
            {
                ...
                {
                    if ((player.Inventory.FindByItemId(Item414)?.Count ?? 0) == 0
                        && !await GiveQuestItemAsync(player, conn, _itemDao, Item414, 1, ct))
                        return true;
        ...
        else if (entry.Status == QuestStatus.REWARD)
        {
            if (targetId == OriataPast61)
            {
                ...
                await RemoveQuestItemAsync(player, conn, _itemDao, Item413, 1, ct);
                await RemoveQuestItemAsync(player, conn, _itemDao, Item414, 1, ct);
