// Port of Java data/scripts/system/handlers/quest/rider_quests/_24053TheMaulingOfTheMau.java (pralinka).
// Level-up / zone-mission gated on 24040. Talk chain 204787 (var0 0->1, plays movie 252 on stray
// QUEST_SELECT/SELECT_ACTION_1012) -> 204795 (1->2) -> 204796 (2->3): on advancing to 3 it spawns the
// survivor (204806) at the player and escorts it to NPC 204813. Reaching there advances var0 3->4 and
// plays movie 253 (defaultFollowEndEvent 3,4,false,253); losing the survivor (or logging out at var0 3)
// rolls var0 3->2. Back at 204787: SET_SUCCEED (var0==4) flips to REWARD. Turn in at 204702.
...
public sealed class _24053TheMaulingOfTheMau : QuestHandlerBase
{
    private const int QuestIdConst = 24053;
    ...
    public _24053TheMaulingOfTheMau(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnZoneMissionEndAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnZoneMissionEndEventAsync(env, conn, 24040, ct);
