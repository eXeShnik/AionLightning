// Port of Java data/scripts/system/handlers/quest/empyrean_crucible/_28213TheColiseumSecret.java (Cheatkiller).
// Asmodian mirror of 18213 TheChillingTruth. Started at 205986 (gives item 182212222); relay at
// 205320 exchanges 182212222 for 182212223 (var0 0->1) then the registered quest item 182212223 is
// used to advance var0 1->2 (Java onItemUseEvent, HandlerResult); final NPC 798804 advances 2->3 and
// grants REWARD; turn in at 798804.
// Java quirk preserved 1:1: at 798804's QUEST_SELECT dialog, if var0 is neither 1 nor 3 the switch
...
public sealed class _28213TheColiseumSecret : QuestHandlerBase
{
    private const int QuestIdConst = 28213;
    private const int StartNpc     = 205986;
    private const int RelayNpc     = 205320;
    private const int TurnInNpc    = 798804;
    private const int GivenItem    = 182212222;
    private const int UsedItem     = 182212223;

    private readonly IItemDao _itemDao;

    public _28213TheColiseumSecret(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
