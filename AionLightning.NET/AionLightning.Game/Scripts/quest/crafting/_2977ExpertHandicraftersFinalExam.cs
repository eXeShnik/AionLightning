// Port of Java data/scripts/system/handlers/quest/crafting/_2977ExpertHandicraftersFinalExam.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the handicrafting trainer (204108),
// turn in 182207949 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2977ExpertHandicraftersFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 2977;
    private const int TrainerNpc  = 204108;
    private const int ProofItemId = 182207949;

    private readonly IItemDao _itemDao;

    public _2977ExpertHandicraftersFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
