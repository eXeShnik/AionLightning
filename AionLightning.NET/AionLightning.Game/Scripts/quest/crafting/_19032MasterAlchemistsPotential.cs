// Port of Java data/scripts/system/handlers/quest/crafting/_19032MasterAlchemistsPotential.java (Thuatan).
// Talk to Cornelius (203786) to start; the recipe-choice npc (203787) hands over one of two
// recipe items (plus a shared instruction book) depending on the SETPRO dialog picked; Cornelius
// then requires the finished proof item (182206768) to flip to REWARD. Note: this quest's
// turn-in failure dialog is 10001, unlike the sibling Potential quests (2716) — preserved as-is,
...
public sealed class _19032MasterAlchemistsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19032;
    private const int CorneliusNpc = 203786;
    private const int RecipeNpc    = 203787;
    private const int Recipe1ItemId = 152202147;
    private const int Recipe2ItemId = 152202148;
    private const int BookItemId    = 152020248;
    private const int ProofItemId   = 182206768;
    private const int FailDialogId  = 10001;

    private readonly IItemDao _itemDao;

    public _19032MasterAlchemistsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
