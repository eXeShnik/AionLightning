// Port of Java data/scripts/system/handlers/quest/crafting/_2975ExpertArmorsmithsFinalExam.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the armorsmith trainer (204106),
// turn in 182207947 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2975ExpertArmorsmithsFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 2975;
    private const int TrainerNpc  = 204106;
    private const int ProofItemId = 182207947;

    private readonly IItemDao _itemDao;

    public _2975ExpertArmorsmithsFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
