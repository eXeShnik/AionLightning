// Port of Java data/scripts/system/handlers/quest/crafting/_29052ExpertPassionforConstruction.java (Ritsu).
// Single-npc quest: Construction trainer (798452) hands in via the quest_data.xml collect-item
...
public sealed class _29052ExpertPassionforConstruction : QuestHandlerBase
{
    private const int QuestIdConst = 29052;
    private const int TrainerNpc = 798452;

    private readonly IItemDao _itemDao;

    public _29052ExpertPassionforConstruction(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
