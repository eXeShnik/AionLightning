// Port of Java data/scripts/system/handlers/quest/crafting/_19055ExpertConstructorsFinalExam.java (Ritsu).
...
public sealed class _19055ExpertConstructorsFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 19055;
    private const int TrainerNpc = 798450;

    private readonly IItemDao _itemDao;

    public _19055ExpertConstructorsFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
