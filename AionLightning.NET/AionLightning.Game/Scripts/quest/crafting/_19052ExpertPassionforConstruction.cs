// Port of Java data/scripts/system/handlers/quest/crafting/_19052ExpertPassionforConstruction.java (Ritsu).
...
public sealed class _19052ExpertPassionforConstruction : QuestHandlerBase
{
    private const int QuestIdConst = 19052;
    private const int TrainerNpc = 798450;

    private readonly IItemDao _itemDao;

    public _19052ExpertPassionforConstruction(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
