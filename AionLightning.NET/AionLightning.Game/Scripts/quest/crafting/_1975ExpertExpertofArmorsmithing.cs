// Port of Java data/scripts/system/handlers/quest/crafting/_1975ExpertExpertofArmorsmithing.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203790), turn in
// 182206894 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1975ExpertExpertofArmorsmithing : QuestHandlerBase
{
    private const int QuestIdConst = 1975;
    private const int CorneliusNpc = 203790;
    private const int ProofItemId  = 182206894;

    private readonly IItemDao _itemDao;

    public _1975ExpertExpertofArmorsmithing(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
