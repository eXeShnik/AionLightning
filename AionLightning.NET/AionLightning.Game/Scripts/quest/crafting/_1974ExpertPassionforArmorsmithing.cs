// Port of Java data/scripts/system/handlers/quest/crafting/_1974ExpertPassionforArmorsmithing.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203790), turn in
// 182206912 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1974ExpertPassionforArmorsmithing : QuestHandlerBase
{
    private const int QuestIdConst = 1974;
    private const int CorneliusNpc = 203790;
    private const int ProofItemId  = 182206912;

    private readonly IItemDao _itemDao;

    public _1974ExpertPassionforArmorsmithing(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
