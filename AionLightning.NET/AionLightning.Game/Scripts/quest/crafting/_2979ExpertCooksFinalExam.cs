// Port of Java data/scripts/system/handlers/quest/crafting/_2979ExpertCooksFinalExam.java (Gigi).
// Single-npc "hand in the crafted proof items" quest: talk to the cooking trainer (204100), turn
// in all four of 182207955/182207956/182207957/182207958 to flip to REWARD, then collect reward.
...
public sealed class _2979ExpertCooksFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 2979;
    private const int TrainerNpc = 204100;
    private const int ProofItem1 = 182207955;
    private const int ProofItem2 = 182207956;
    private const int ProofItem3 = 182207957;
    private const int ProofItem4 = 182207958;

    private readonly IItemDao _itemDao;

    public _2979ExpertCooksFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        if (status == QuestStatus.START && dialog == DialogAction.QUEST_SELECT)
        {
            ...
            long count4 = player.Inventory.FindByItemId(ProofItem4)?.Count ?? 0;
            ...
            await RemoveQuestItemAsync(player, conn, _itemDao, ProofItem4, 1, ct);
