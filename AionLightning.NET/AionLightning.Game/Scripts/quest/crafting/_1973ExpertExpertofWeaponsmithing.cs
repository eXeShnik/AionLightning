// Port of Java data/scripts/system/handlers/quest/crafting/_1973ExpertExpertofWeaponsmithing.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203788), turn in
// 182206893 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1973ExpertExpertofWeaponsmithing : QuestHandlerBase
{
    private const int QuestIdConst = 1973;
    private const int CorneliusNpc = 203788;
    private const int ProofItemId  = 182206893;

    private readonly IItemDao _itemDao;

    public _1973ExpertExpertofWeaponsmithing(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
