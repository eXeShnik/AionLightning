// Port of Java data/scripts/system/handlers/quest/crafting/_2978ExpertCooksTest.java (Gigi).
// Single-npc "hand in the crafted proof items" quest: talk to the cooking trainer (204100), turn
// in all three of 182207972/182207973/182207974 to flip to REWARD, then collect the reward.
...
public sealed class _2978ExpertCooksTest : QuestHandlerBase
{
    private const int QuestIdConst = 2978;
    private const int TrainerNpc = 204100;
    private const int ProofItem1 = 182207972;
    private const int ProofItem2 = 182207973;
    private const int ProofItem3 = 182207974;

    private readonly IItemDao _itemDao;

    public _2978ExpertCooksTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
