// Port of Java data/scripts/system/handlers/quest/crafting/_2982ExpertTailorsTest.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the tailoring trainer (204110), turn
// in 182207966 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2982ExpertTailorsTest : QuestHandlerBase
{
    private const int QuestIdConst = 2982;
    private const int TrainerNpc  = 204110;
    private const int ProofItemId = 182207966;

    private readonly IItemDao _itemDao;

    public _2982ExpertTailorsTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
