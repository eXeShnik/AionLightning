// Port of Java data/scripts/system/handlers/quest/crafting/_1977ExpertExpertofHandicrafting.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203792), turn in
// 182206896 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1977ExpertExpertofHandicrafting : QuestHandlerBase
{
    private const int QuestIdConst = 1977;
    private const int CorneliusNpc = 203792;
    private const int ProofItemId  = 182206896;

    private readonly IItemDao _itemDao;

    public _1977ExpertExpertofHandicrafting(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
