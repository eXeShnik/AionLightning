// Port of Java data/scripts/system/handlers/quest/crafting/_19014MasterArmorsmithsPotential.java (Thuatan).
// Talk to Cornelius (203790) to start; the recipe-choice npc (203791) hands over one of two
// recipe items depending on the SETPRO dialog picked; Cornelius then requires the finished proof
// item (182206765) to flip to REWARD.
...
public sealed class _19014MasterArmorsmithsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19014;
    private const int CorneliusNpc = 203790;
    private const int RecipeNpc    = 203791;
    private const int Recipe1ItemId = 152201806;
    private const int Recipe2ItemId = 152201807;
    private const int ProofItemId   = 182206765;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _19014MasterArmorsmithsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
