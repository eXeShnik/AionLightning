// Port of Java data/scripts/system/handlers/quest/crafting/_29008MasterWeaponsmithsPotential.java (Thuatan).
// Talk to the weaponsmith trainer (204104) to start; the recipe-choice npc (204105) hands over
// one of two recipe items (plus a shared instruction book); the trainer then requires the
// finished proof item (182207898) to flip to REWARD.
...
public sealed class _29008MasterWeaponsmithsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 29008;
    private const int TrainerNpc = 204104;
    private const int RecipeNpc  = 204105;
    private const int Recipe1ItemId = 152206708;
    private const int Recipe2ItemId = 152206709;
    private const int BookItemId    = 152029251;
    private const int ProofItemId   = 182207898;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _29008MasterWeaponsmithsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
