// Port of Java data/scripts/system/handlers/quest/crafting/_2974ExpertArmorsmithsTest.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the armorsmith trainer (204106),
// turn in 182207965 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2974ExpertArmorsmithsTest : QuestHandlerBase
{
    private const int QuestIdConst = 2974;
    private const int TrainerNpc  = 204106;
    private const int ProofItemId = 182207965;

    private readonly IItemDao _itemDao;

    public _2974ExpertArmorsmithsTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
