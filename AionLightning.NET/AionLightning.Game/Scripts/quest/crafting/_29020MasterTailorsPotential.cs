// Port of Java data/scripts/system/handlers/quest/crafting/_29020MasterTailorsPotential.java (Thuatan).
// Talk to the tailoring trainer (204110) to start; the recipe-choice npc (204111) hands over one
// of two recipe items; the trainer then requires the finished proof item (182207900) to flip to
// REWARD.
...
public sealed class _29020MasterTailorsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 29020;
    private const int TrainerNpc = 204110;
    private const int RecipeNpc  = 204111;
    private const int Recipe1ItemId = 152206964;
    private const int Recipe2ItemId = 152206965;
    private const int ProofItemId   = 182207900;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _29020MasterTailorsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
