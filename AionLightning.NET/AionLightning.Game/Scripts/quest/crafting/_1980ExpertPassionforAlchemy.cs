// Port of Java data/scripts/system/handlers/quest/crafting/_1980ExpertPassionforAlchemy.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203786), turn in
// 182206915 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1980ExpertPassionforAlchemy : QuestHandlerBase
{
    private const int QuestIdConst = 1980;
    private const int CorneliusNpc = 203786;
    private const int ProofItemId  = 182206915;

    private readonly IItemDao _itemDao;

    public _1980ExpertPassionforAlchemy(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
