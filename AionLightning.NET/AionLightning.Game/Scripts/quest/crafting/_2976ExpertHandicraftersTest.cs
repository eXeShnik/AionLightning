// Port of Java data/scripts/system/handlers/quest/crafting/_2976ExpertHandicraftersTest.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the handicrafting trainer (204108),
// turn in 182207967 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2976ExpertHandicraftersTest : QuestHandlerBase
{
    private const int QuestIdConst = 2976;
    private const int TrainerNpc  = 204108;
    private const int ProofItemId = 182207967;

    private readonly IItemDao _itemDao;

    public _2976ExpertHandicraftersTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
