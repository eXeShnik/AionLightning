// Port of Java data/scripts/system/handlers/quest/crafting/_1981ExpertExpertofAlchemy.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203786), turn in
// 182206897 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1981ExpertExpertofAlchemy : QuestHandlerBase
{
    private const int QuestIdConst = 1981;
    private const int CorneliusNpc = 203786;
    private const int ProofItemId  = 182206897;

    private readonly IItemDao _itemDao;

    public _1981ExpertExpertofAlchemy(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
