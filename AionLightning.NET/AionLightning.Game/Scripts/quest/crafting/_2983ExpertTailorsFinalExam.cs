// Port of Java data/scripts/system/handlers/quest/crafting/_2983ExpertTailorsFinalExam.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the tailoring trainer (204110), turn
// in 182207948 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2983ExpertTailorsFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 2983;
    private const int TrainerNpc  = 204110;
    private const int ProofItemId = 182207948;

    private readonly IItemDao _itemDao;

    public _2983ExpertTailorsFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
