// Port of Java data/scripts/system/handlers/quest/crafting/_19008MasterWeaponsmithsPotential.java (Thuatan).
// Talk to Cornelius (203788) to start; the recipe-choice npc (203789) hands over one of two
// recipe items (plus a shared instruction book) depending on the SETPRO dialog picked; Cornelius
// then requires the finished proof item (182206764) to flip to REWARD.
...
public sealed class _19008MasterWeaponsmithsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19008;
    private const int CorneliusNpc = 203788;
    private const int RecipeNpc    = 203789;
    private const int Recipe1ItemId = 152201706;
    private const int Recipe2ItemId = 152201707;
    private const int BookItemId    = 152020250;
    private const int ProofItemId   = 182206764;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _19008MasterWeaponsmithsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
