// Port of Java data/scripts/system/handlers/quest/crafting/_29026MasterHandicraftersPotential.java (Thuatan).
// Talk to the handicrafting trainer (204108) to start; the recipe-choice npc (798060) hands over
// one of two recipe items (plus a shared instruction book); the trainer then requires the
// finished proof item (182207901) to flip to REWARD.
...
public sealed class _29026MasterHandicraftersPotential : QuestHandlerBase
{
    private const int QuestIdConst = 29026;
    private const int TrainerNpc = 204108;
    private const int RecipeNpc  = 798060;
    private const int Recipe1ItemId = 152207051;
    private const int Recipe2ItemId = 152207052;
    private const int BookItemId    = 152029250;
    private const int ProofItemId   = 182207901;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _29026MasterHandicraftersPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
