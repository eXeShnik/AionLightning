// Port of Java data/scripts/system/handlers/quest/crafting/_19038MasterCooksPotential.java (Thuatan, reworked vlog).
// Four cooking stages: talk to Luelas (203785, RecipeNpc) with QUEST_SELECT to get instructions,
// pick a SETPRO button to pay 6500 kinah and receive the stage material (var 0->2, 3->5, 6->8,
// 9->11); craft the proof item; a failed craft rolls the stage back one (2->1, 5->4, 8->7, 11->10)
// via the onFailCraft hook; then hand the finished proof to Hestia (203784, TurnInNpc) to advance
// (2->3, 5->6, 8->9, 11->REWARD). Kinah is modeled as inventory item 182400001 per the established
// "Kinah as item" convention (see _19057MasterConstructorsPotential and migration_plan.md).
...
public sealed class _19038MasterCooksPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19038;
    private const int TurnInNpc = 203784; // Hestia
    private const int RecipeNpc = 203785; // Luelas
    private const int KinahItemId = 182400001;
    private const long StageCost = 6500;

    private const int Recipe1Id = 155002239;
    private const int Recipe2Id = 155002240;
    private const int Recipe3Id = 155002241;
    private const int Recipe4Id = 155002242;

    private const int Material1Id = 152202200;
    private const int Material2Id = 152202201;
    private const int Material3Id = 152202202;
    private const int Material4Id = 152202203;

    private const int Proof1Id = 182206773;
    private const int Proof2Id = 182206774;
    private const int Proof3Id = 182206775;
    private const int Proof4Id = 182206776;

    private readonly IItemDao _itemDao;

    public _19038MasterCooksPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    {
        var hestia = engine.RegisterQuestNpc(TurnInNpc);
