// Port of Java data/scripts/system/handlers/quest/crafting/_1972ExpertPassionforWeaponsmithing.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203788), turn in
// 182206911 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1972ExpertPassionforWeaponsmithing : QuestHandlerBase
{
    private const int QuestIdConst = 1972;
    private const int CorneliusNpc = 203788;
    private const int ProofItemId  = 182206911;

    private readonly IItemDao _itemDao;

    public _1972ExpertPassionforWeaponsmithing(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
