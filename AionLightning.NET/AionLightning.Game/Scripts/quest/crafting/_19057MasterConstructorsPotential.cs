// Port of Java data/scripts/system/handlers/quest/crafting/_19057MasterConstructorsPotential.java (Ritsu).
// Talk to the Construction trainer (798450) to start; the recipe-choice npc (798451) sells one of
// two blueprint items for kinah (167500 / 223000, modeled as item 182400001 per the CM_BUY_ITEM
// convention — see _3961GrowthFlorasFirstCharm and the "Kinah as item" note in migration_plan.md);
// the trainer's collect-item check then picks a different failure dialog depending on whether the
// player already knows one of the two recipes or is still carrying an unused blueprint.
using System.Linq;
...
public sealed class _19057MasterConstructorsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19057;
    private const int TrainerNpc = 798450;
    private const int RecipeNpc  = 798451;
    private const int KinahItemId = 182400001;

    private static readonly int[] RecipeItemIds = [152203543, 152203544];
    private static readonly int[] RecipeIds      = [155003543, 155003544];
    private static readonly long[] KinahCosts     = [167500, 223000];

    private readonly IItemDao _itemDao;

    public _19057MasterConstructorsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
