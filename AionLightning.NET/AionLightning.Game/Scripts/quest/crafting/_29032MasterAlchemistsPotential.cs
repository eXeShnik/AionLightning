// Port of Java data/scripts/system/handlers/quest/crafting/_29032MasterAlchemistsPotential.java (Thuatan).
// Talk to the alchemy trainer (204102) to start; the recipe-choice npc (204103) hands over one
// of two recipe items (plus a shared instruction book); the trainer then requires the finished
// proof item (182207902) to flip to REWARD.
...
public sealed class _29032MasterAlchemistsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 29032;
    private const int TrainerNpc = 204102;
    private const int RecipeNpc  = 204103;
    private const int Recipe1ItemId = 152207149;
    private const int Recipe2ItemId = 152207150;
    private const int BookItemId    = 152029249;
    private const int ProofItemId   = 182207902;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _29032MasterAlchemistsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
