// Port of Java data/scripts/system/handlers/quest/crafting/_29055ExpertConstructorsFinalExam.java (Ritsu).
...
public sealed class _29055ExpertConstructorsFinalExam : QuestHandlerBase
{
    private const int QuestIdConst = 29055;
    private const int TrainerNpc = 798452;

    private readonly IItemDao _itemDao;

    public _29055ExpertConstructorsFinalExam(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
