// Port of Java data/scripts/system/handlers/quest/crafting/_1976ExpertPassionforHandicrafting.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203792), turn in
// 182206914 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1976ExpertPassionforHandicrafting : QuestHandlerBase
{
    private const int QuestIdConst = 1976;
    private const int CorneliusNpc = 203792;
    private const int ProofItemId  = 182206914;

    private readonly IItemDao _itemDao;

    public _1976ExpertPassionforHandicrafting(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
