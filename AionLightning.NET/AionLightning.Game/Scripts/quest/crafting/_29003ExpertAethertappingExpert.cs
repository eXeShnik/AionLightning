...
public sealed class _29003ExpertAethertappingExpert : QuestHandlerBase
{
    private const int QuestIdConst = 29003;
    private const int BarakaNpc   = 204257;
    private const int VaterosNpc  = 798800;
    private const int ToolItemId  = 182207142;

    private readonly IItemDao _itemDao;

    public _29003ExpertAethertappingExpert(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
