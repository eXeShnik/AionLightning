// Port of Java data/scripts/system/handlers/quest/crafting/_2980ExpertAlchemistsTest.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to the alchemy trainer (204102), turn
// in 182207968 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _2980ExpertAlchemistsTest : QuestHandlerBase
{
    private const int QuestIdConst = 2980;
    private const int TrainerNpc  = 204102;
    private const int ProofItemId = 182207968;

    private readonly IItemDao _itemDao;

    public _2980ExpertAlchemistsTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
