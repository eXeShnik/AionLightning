// Port of Java data/scripts/system/handlers/quest/crafting/_19002ExpertAethertappersTest.java (Gigi).
// Talk to Doban (203782) to start; Rhess (203783) hands over the aether-tapping tool
// (122001251); Doban then requires two gathered materials (152003007 + 152003008) in one hand-in.
// Fallthrough note: same "info dialog falls into the act dialog" idiom as _19000 — preserved via
// stacked case labels.
...
public sealed class _19002ExpertAethertappersTest : QuestHandlerBase
{
    private const int QuestIdConst = 19002;
    private const int DobanNpc  = 203782;
    private const int RhessNpc  = 203783;
    ...
    public _19002ExpertAethertappersTest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override void Register(QuestEngine engine)
    {
        ...
        engine.RegisterQuestNpc(RhessNpc).OnTalk.Add(QuestId);
    }
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        if (status == QuestStatus.START)
        {
            ...
            else if (targetId == DobanNpc && dialog == DialogAction.QUEST_SELECT)
            {
