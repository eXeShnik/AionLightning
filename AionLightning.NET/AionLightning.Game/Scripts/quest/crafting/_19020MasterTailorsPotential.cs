// Port of Java data/scripts/system/handlers/quest/crafting/_19020MasterTailorsPotential.java (Thuatan).
// Talk to Cornelius (203793) to start; the recipe-choice npc (203794) hands over one of two
// recipe items depending on the SETPRO dialog picked; Cornelius then requires the finished proof
// item (182206766) to flip to REWARD.
...
public sealed class _19020MasterTailorsPotential : QuestHandlerBase
{
    private const int QuestIdConst = 19020;
    private const int CorneliusNpc = 203793;
    private const int RecipeNpc    = 203794;
    private const int Recipe1ItemId = 152201962;
    private const int Recipe2ItemId = 152201963;
    private const int ProofItemId   = 182206766;
    private const int FailDialogId  = 2716;

    private readonly IItemDao _itemDao;

    public _19020MasterTailorsPotential(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
