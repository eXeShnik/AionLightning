// Port of Java data/scripts/system/handlers/quest/crafting/_1982ExpertAPassionForTailoring.java (Gigi).
// Single-npc "hand in the crafted proof item" quest: talk to Cornelius (203793), turn in
// 182206913 to flip to REWARD, then collect the standard quest reward.
...
public sealed class _1982ExpertAPassionForTailoring : QuestHandlerBase
{
    private const int QuestIdConst = 1982;
    private const int CorneliusNpc = 203793;
    private const int ProofItemId  = 182206913;

    private readonly IItemDao _itemDao;

    public _1982ExpertAPassionForTailoring(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
