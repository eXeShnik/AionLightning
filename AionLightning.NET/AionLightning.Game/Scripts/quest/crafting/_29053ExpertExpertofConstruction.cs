// Port of Java data/scripts/system/handlers/quest/crafting/_29053ExpertExpertofConstruction.java (Ritsu).
...
public sealed class _29053ExpertExpertofConstruction : QuestHandlerBase
{
    private const int QuestIdConst = 29053;
    private const int TrainerNpc = 798452;

    private readonly IItemDao _itemDao;

    public _29053ExpertExpertofConstruction(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
