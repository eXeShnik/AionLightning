// Port of Java data/scripts/system/handlers/quest/crafting/_1979ExpertExpertofCooking.java (Gigi).
// Single-npc "hand in the crafted proof items" quest: talk to Hestia (203784), turn in all four
// of 182206902/182206903/182206904/182206905 to flip to REWARD, then collect the standard reward.
...
public sealed class _1979ExpertExpertofCooking : QuestHandlerBase
{
    private const int QuestIdConst = 1979;
    private const int HestiaNpc = 203784;
    private const int ProofItem1 = 182206902;
    private const int ProofItem2 = 182206903;
    private const int ProofItem3 = 182206904;
    private const int ProofItem4 = 182206905;

    private readonly IItemDao _itemDao;

    public _1979ExpertExpertofCooking(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
