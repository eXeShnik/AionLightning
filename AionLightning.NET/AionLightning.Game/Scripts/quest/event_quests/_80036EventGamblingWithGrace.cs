// Port of Java data/scripts/system/handlers/quest/event_quests/_80036EventGamblingWithGrace.java (npc 799765).
...
public sealed class _80036EventGamblingWithGrace : QuestHandlerBase
{
    private const int QuestIdConst    = 80036;
    private const int Npc             = 799765;
    private const int RestartItem     = 164002018; // Aion's Grace
    private const int RestartMinCount = 0;         // Java: count > 0

    private readonly IItemDao _itemDao;

    public _80036EventGamblingWithGrace(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    // Java sendQuestRewardDialog(env, 799765, reportDialogId): a REWARD-status turn-in shows
