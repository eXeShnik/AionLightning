// Port of Java data/scripts/system/handlers/quest/event_quests/_80039EventTheChosenFew.java (npc 799780).
...
public sealed class _80039EventTheChosenFew : QuestHandlerBase
{
    private const int QuestIdConst    = 80039;
    private const int Npc             = 799780;
    private const int RestartItem     = 164002018; // Aion's Grace
    private const int RestartMinCount = 0;         // Java: count > 0 (restart quest if more remain)

    private readonly IItemDao _itemDao;

    public _80039EventTheChosenFew(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
