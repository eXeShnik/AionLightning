// Port of Java data/scripts/system/handlers/quest/event_quests/_50008SoloriusShugoSlackers.java (Alcapwnd).
// Start/turn-in at 831038. When NPC 219290 first aggros the player (onAddAggroList), the aggroed NPC
...
public sealed class _50008SoloriusShugoSlackers : QuestHandlerBase
{
    private const int QuestIdConst = 50008;
    private const int StartNpc     = 831038;
    private const int AggroNpc     = 219290;
    private const string FollowZone = "Q51008";

    public _50008SoloriusShugoSlackers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
