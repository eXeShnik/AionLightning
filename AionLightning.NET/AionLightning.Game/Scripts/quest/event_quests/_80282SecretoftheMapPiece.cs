// Port of Java data/scripts/system/handlers/quest/event_quests/_80282SecretoftheMapPiece.java.
// Accept at Xurabo (831117); turn in at Kubu (831350, OnTalk-registered this time).
...
public sealed class _80282SecretoftheMapPiece : QuestHandlerBase
{
    private const int QuestIdConst = 80282;
    private const int XuraboNpc    = 831117;
    private const int KubuNpc      = 831350;

    public _80282SecretoftheMapPiece(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
