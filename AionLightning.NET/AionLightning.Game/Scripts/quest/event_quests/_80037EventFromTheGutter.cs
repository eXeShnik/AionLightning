// Port of Java data/scripts/system/handlers/quest/event_quests/_80037EventFromTheGutter.java (npc 799780).
...
public sealed class _80037EventFromTheGutter : QuestHandlerBase
{
    private const int QuestIdConst    = 80037;
    private const int Npc             = 799780;
    private const int RestartItem     = 164002016; // Israphel's Glory
    private const int RestartMinCount = 9;         // Java: count > 9

    private readonly IItemDao _itemDao;

    public _80037EventFromTheGutter(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    {
        // note: Java omits the `env.getQuestId() != questId` guard here (unlike sibling 80034-80039).
        //   Harmless — the engine dispatches this hook per registered quest — but preserved faithfully.
        if (bonusType != "LUNAR")
