// Port of Java data/scripts/system/handlers/quest/katalam/_22852IngiRequest.java (Romanz).
...
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at IngiRequest (801247).
...
public sealed class _22852IngiRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22852;
    private const int TurnInNpc      = 801247;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "CHILLBREEZE_VALLEY_600050000";

    public _22852IngiRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
