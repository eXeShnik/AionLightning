// Port of Java data/scripts/system/handlers/quest/katalam/_22848EyjaRequest.java (Romanz).
...
// port here, e.g. danaria's _23350HervoRequest); turn in at EyjaRequest (801243). qs.canRepeat()
...
public sealed class _22848EyjaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22848;
    private const int TurnInNpc      = 801243;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "RELICS_OF_SORROW_600050000";

    public _22848EyjaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
