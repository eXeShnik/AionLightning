// Port of Java data/scripts/system/handlers/quest/katalam/_12852IoleRequest.java (Romanz).
// Auto-starts on entering Katalam's CHILLBREEZE_VALLEY_600050000 region (registerOnEnterZone ->
...
// additionally required player.isInsideZone(CHILLBREEZE_VALLEY_600050000) — no zone-shape infra in
// this port, so the trigger is broadened to "anywhere in the world", matching every other
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at IoleRequest (801238).
...
public sealed class _12852IoleRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12852;
    private const int TurnInNpc      = 801238;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "CHILLBREEZE_VALLEY_600050000";

    public _12852IoleRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
