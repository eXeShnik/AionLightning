// Port of Java data/scripts/system/handlers/quest/katalam/_22847DagstyrrRequest.java (Romanz).
...
// port here, e.g. danaria's _23350HervoRequest); turn in at DagstyrrRequest (801242). qs.canRepeat()
...
public sealed class _22847DagstyrrRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22847;
    private const int TurnInNpc      = 801242;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "PRIMEVAL_RUINS_600050000";

    public _22847DagstyrrRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
