// Port of Java data/scripts/system/handlers/quest/katalam/_12849FabianaRequest.java (Romanz).
// Auto-starts on entering Katalam's TORN_LAND_600050000 region (registerOnEnterZone ->
...
// additionally required player.isInsideZone(TORN_LAND_600050000) — no zone-shape infra in this port,
// so the trigger is broadened to "anywhere in the world", matching every other kill_in_world port
// here, e.g. danaria's _23350HervoRequest); turn in at FabianaRequest (801235). qs.canRepeat()
...
public sealed class _12849FabianaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12849;
    private const int TurnInNpc      = 801235;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "TORN_LAND_600050000";

    public _12849FabianaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
