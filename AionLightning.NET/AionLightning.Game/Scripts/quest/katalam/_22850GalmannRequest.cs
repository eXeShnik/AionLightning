// Port of Java data/scripts/system/handlers/quest/katalam/_22850GalmannRequest.java (Romanz).
// Auto-starts on entering Katalam's BERITRAS_BANE_PROTECTORATE_600050000 region (registerOnEnterZone
...
// additionally required player.isInsideZone(BERITRAS_BANE_PROTECTORATE_600050000) — no zone-shape
// infra in this port, so the trigger is broadened to "anywhere in the world", matching every other
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at GalmannRequest (801245).
...
public sealed class _22850GalmannRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22850;
    private const int TurnInNpc      = 801245;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "BERITRAS_BANE_PROTECTORATE_600050000";

    public _22850GalmannRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
