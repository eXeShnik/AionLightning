// Port of Java data/scripts/system/handlers/quest/katalam/_12848EgnatiaRequest.java (Romanz).
// Auto-starts on entering Katalam's RELICS_OF_SORROW_600050000 region (registerOnEnterZone ->
...
// additionally required player.isInsideZone(RELICS_OF_SORROW_600050000) — no zone-shape infra in this
// port, so the trigger is broadened to "anywhere in the world", matching every other kill_in_world
// port here, e.g. danaria's _23350HervoRequest); turn in at EgnatiaRequest (801234). qs.canRepeat()
...
public sealed class _12848EgnatiaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12848;
    private const int TurnInNpc      = 801234;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "RELICS_OF_SORROW_600050000";

    public _12848EgnatiaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
