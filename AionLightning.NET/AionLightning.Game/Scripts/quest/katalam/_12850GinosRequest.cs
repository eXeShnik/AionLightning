// Port of Java data/scripts/system/handlers/quest/katalam/_12850GinosRequest.java (Romanz).
...
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at GinosRequest (801236).
...
public sealed class _12850GinosRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12850;
    private const int TurnInNpc      = 801236;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "BERITRAS_BANE_PROTECTORATE_600050000";

    public _12850GinosRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
