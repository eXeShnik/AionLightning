// Port of Java data/scripts/system/handlers/quest/katalam/_12509AMilitaryConspiracy.java (Ritsu/apozema).
// Talk to 801028 to accept (gives item 182213307, dialog 4762/1003); kill 701735 (var 0->1); use
// the item while targeting the decoration npc named 372608 (var 1->2, reward flip); turn in at
// 801018.
...
// katalam/_1845OpeningDoors.cs, brusthonin/_4053GlossyHoe.cs, etc.).
...
public sealed class _12509AMilitaryConspiracy : QuestHandlerBase
{
    private const int QuestIdConst = 12509;
    private const int StartNpc     = 801028;
    private const int TurnInNpc    = 801018;
    private const int KillNpc      = 701735;
    private const int LetterItemId = 182213307;
    private const int TargetNameId = 372608;

    private readonly IItemDao _itemDao;

    public _12509AMilitaryConspiracy(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
