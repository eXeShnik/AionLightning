// Port of Java data/scripts/system/handlers/quest/katalam/_22851PutThemOnIce.java (Romanz).
...
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at PutThemOnIce npc (801246).
...
public sealed class _22851PutThemOnIce : QuestHandlerBase
{
    private const int QuestIdConst   = 22851;
    private const int TurnInNpc      = 801246;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "SILLUS_FORTRESS_PATHWAY_600050000";

    public _22851PutThemOnIce(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
