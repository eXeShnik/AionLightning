// Port of Java data/scripts/system/handlers/quest/katalam/_12844AnastasiaRequest.java (Romanz).
// Auto-starts on entering Katalam's WZ_WEATHERZONELDF5A_WEATHER2_600050000 region (registerOnEnterZone
...
// additionally required player.isInsideZone(WZ_WEATHERZONELDF5A_WEATHER2_600050000) — no zone-shape
// infra in this port, so the trigger is broadened to "anywhere in the world", matching every other
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at AnastasiaRequest (801230).
// qs.canRepeat() (daily-reset re-entry) isn't ported, matching every other kill_in_world quest already
// in this codebase.
...
public sealed class _12844AnastasiaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12844;
    private const int TurnInNpc      = 801230;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "WZ_WEATHERZONELDF5A_WEATHER2_600050000";

    public _12844AnastasiaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
