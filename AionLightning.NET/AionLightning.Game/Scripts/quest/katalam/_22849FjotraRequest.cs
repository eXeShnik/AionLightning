// Port of Java data/scripts/system/handlers/quest/katalam/_22849FjotraRequest.java (Romanz).
...
// here, e.g. danaria's _23350HervoRequest); turn in at FjotraRequest (801244). qs.canRepeat()
...
public sealed class _22849FjotraRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22849;
    private const int TurnInNpc      = 801244;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "TORN_LAND_600050000";

    public _22849FjotraRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
