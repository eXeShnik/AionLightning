// Port of Java data/scripts/system/handlers/quest/katalam/_22845BatanRequest.java (Romanz).
// Auto-starts on entering Katalam's SPIRALROOT_SHELTER_600050000 region (registerOnEnterZone ->
...
// additionally required player.isInsideZone(SPIRALROOT_SHELTER_600050000) — no zone-shape infra in
// this port, so the trigger is broadened to "anywhere in the world", matching every other
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at BatanRequest (801240).
...
public sealed class _22845BatanRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22845;
    private const int TurnInNpc      = 801240;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "SPIRALROOT_SHELTER_600050000";

    public _22845BatanRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
