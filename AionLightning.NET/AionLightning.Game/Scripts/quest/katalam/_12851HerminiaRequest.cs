// Port of Java data/scripts/system/handlers/quest/katalam/_12851HerminiaRequest.java (Romanz).
// Auto-starts on entering Katalam's SILLUS_FORTRESS_PATHWAY_600050000 region (registerOnEnterZone ->
...
// additionally required player.isInsideZone(SILLUS_FORTRESS_PATHWAY_600050000) — no zone-shape infra
// in this port, so the trigger is broadened to "anywhere in the world", matching every other
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at HerminiaRequest (801237).
...
public sealed class _12851HerminiaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 12851;
    private const int TurnInNpc      = 801237;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "SILLUS_FORTRESS_PATHWAY_600050000";

    public _12851HerminiaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
