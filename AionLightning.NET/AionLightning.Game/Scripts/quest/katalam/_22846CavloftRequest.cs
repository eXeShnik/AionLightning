// Port of Java data/scripts/system/handlers/quest/katalam/_22846CavloftRequest.java (Romanz).
...
// kill_in_world port here, e.g. danaria's _23350HervoRequest); turn in at CavloftRequest (801241).
...
public sealed class _22846CavloftRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 22846;
    private const int TurnInNpc      = 801241;
    private const int KatalamWorldId = 600050000;
    private const string EnterZoneName = "BERITRAN_FOOTHOLD_600050000";

    public _22846CavloftRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
