// Port of Java data/scripts/system/handlers/quest/pandaemonium/_4971ProjectRunway.java.
// Accept default at 798393; 3-step chain (204119 var0 0->1, 204727 var0 1->2, 798300 SETPRO3 sets
// var0=3 straight to REWARD); turn in at 798393.
...
public sealed class _4971ProjectRunway : QuestHandlerBase
{
    private const int QuestIdConst = 4971;
    private const int StartNpc = 798393;
    private const int StepOneNpc = 204119;
    private const int StepTwoNpc = 204727;
    private const int StepThreeNpc = 798300;

    public _4971ProjectRunway(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
