// Port of Java data/scripts/system/handlers/quest/pandaemonium/_2953DeliveringSupplyRequest.java.
// Accept at Doman (204191) gives item 182207039 x1; single-dialog step at Veldina (204071, var
...
public sealed class _2953DeliveringSupplyRequest : QuestHandlerBase
{
    private const int QuestIdConst = 2953;
    private const int DomanNpc = 204191;
    private const int VeldinaNpc = 204071;
    private const int GiftItemId = 182207039;

    private readonly IItemDao _itemDao;

    public _2953DeliveringSupplyRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override void Register(QuestEngine engine)
    {
        ...
        engine.RegisterQuestNpc(VeldinaNpc).OnTalk.Add(QuestId);
    }
