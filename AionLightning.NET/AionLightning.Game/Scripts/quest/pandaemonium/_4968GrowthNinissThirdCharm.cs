// Port of Java data/scripts/system/handlers/quest/pandaemonium/_4968GrowthNinissThirdCharm.java.
// Accept default at Ninis (798385); Maochinicherk (798068) gives the Charm Certificate
// (182207138); back at Ninis, handing in the Glowing Aether Paper (186000092) plus 70000 kinah
...
public sealed class _4968GrowthNinissThirdCharm : QuestHandlerBase
{
    private const int QuestIdConst = 4968;
    private const int NinisNpc = 798385;
    private const int MaochinicherkNpc = 798068;
    private const int CertificateItem = 182207138;
    private const int AetherPaperItem = 186000092;
    private const long KinahCost = 70000;
    private const int KinahItemId = 182400001;

    private readonly IItemDao _itemDao;

    public _4968GrowthNinissThirdCharm(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
