// Port of Java data/scripts/system/handlers/quest/pandaemonium/_4967GrowthNinissSecondCharm.java.
// Accept default at Ninis (798385); Maochinicherk (798068) gives the Charm Certificate
// (182207137); back at Ninis, handing in the Glossy Aether Paper (186000091, kept — not a quest
// item, just checked/consumed manually) plus 50000 kinah flips to REWARD; turn in at Ninis.
// Same dead-fallthrough simplification as _4966GrowthNinissFirstCharm.cs.
...
public sealed class _4967GrowthNinissSecondCharm : QuestHandlerBase
{
    private const int QuestIdConst = 4967;
    private const int NinisNpc = 798385;
    private const int MaochinicherkNpc = 798068;
    private const int CertificateItem = 182207137;
    private const int AetherPaperItem = 186000091;
    private const long KinahCost = 50000;
    private const int KinahItemId = 182400001;

    private readonly IItemDao _itemDao;

    public _4967GrowthNinissSecondCharm(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        if (targetId == NinisNpc)
        {
            ...
            if (dialog == DialogAction.CHECK_USER_HAS_QUEST_ITEM || (dialog == DialogAction.QUEST_SELECT && var != 1))
            {
                ...
                if (var == 1 && paperCount >= 1 && await TryDeductKinahAsync(player, conn, KinahCost, ct))
                {
