// Port of Java data/scripts/system/handlers/quest/pandaemonium/_2965AncientWeapons.java.
// Accept + turn in both at 204182; 2-step chain (204055 var0 0->1, 278002 var0 1->2, both via
// manual var-increment + raw selection dialog, matching Java's PacketSendUtility call); final
// SELECT_QUEST_REWARD at 278109 sets var0=3 and flips to REWARD.
...
public sealed class _2965AncientWeapons : QuestHandlerBase
{
    private const int QuestIdConst = 2965;
    private const int StartNpc = 204182;
    private const int StepOneNpc = 204055;
    private const int StepTwoNpc = 278002;
    private const int TurnInNpc = 278109;

    public _2965AncientWeapons(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
