// Port of Java data/scripts/system/handlers/quest/weapon_enchant/_22411ThePerfectHarp.java.
// Asmodian counterpart of _12411BuildABetterHarp - identical structure and npcs. Auto-starts on
// level-up once quest 10064 is complete (zone-mission style, min level 60, Asmodian only -
// class/gender gating from quest_data.xml isn't ported, see QuestHandlerBase). Accept at Ulian
// (205892); Grais (205891) and Lumen (205575) each show a lore dialog and advance var0 (0->1,
// 1->2); handing in the crafting materials (quest_data.xml collect_items: Adella's Harp +
// Upsorceller + Magical Aether Crystal + Fusion Fragment) at Ulian flips straight to REWARD; turn
// in at Ulian.
//
...
public sealed class _22411ThePerfectHarp : QuestHandlerBase
{
    private const int QuestIdConst = 22411;
    ...
    public _22411ThePerfectHarp(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
