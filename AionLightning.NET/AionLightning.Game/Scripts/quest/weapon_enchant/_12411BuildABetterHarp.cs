// Port of Java data/scripts/system/handlers/quest/weapon_enchant/_12411BuildABetterHarp.java.
// Auto-starts on level-up once quest 10064 is complete (zone-mission style, min level 60, Elyos
// only - class/gender gating from quest_data.xml isn't ported, see QuestHandlerBase). Accept at
// Ulian (205892); Grais (205891) and Lumen (205575) each show a lore dialog and advance var0
// (0->1, 1->2); handing in the crafting materials (quest_data.xml collect_items: Adella's Harp +
...
public sealed class _12411BuildABetterHarp : QuestHandlerBase
{
    private const int QuestIdConst = 12411;
    ...
    public _12411BuildABetterHarp(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
