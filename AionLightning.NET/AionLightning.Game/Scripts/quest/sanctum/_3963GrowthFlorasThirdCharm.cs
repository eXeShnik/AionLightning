// Port of Java data/scripts/system/handlers/quest/sanctum/_3963GrowthFlorasThirdCharm.java (undertrey / vlog).
// Talk to Flora (798384) to start; Erdos (203740) hands over a charm-request slip (item
// 182206110, var 0->1); bring it back to Flora with a Red Aether Powder (186000089) and 70000
// kinah to advance to REWARD. Java bug fixes: the original (1) decreased kinah before checking the
// powder count, so a player without the powder still lost the kinah, and (2) called
// tryDecreaseKinah(70000) *and* decreaseKinah(70000) back to back, charging 140000 instead of
// 70000; this port checks the powder first and deducts kinah exactly once.
...
public sealed class _3963GrowthFlorasThirdCharm : QuestHandlerBase
{
    private const int QuestIdConst = 3963;
    private const int FloraNpc     = 798384;
    private const int ErdosNpc     = 203740;
    private const int RequestItemId = 182206110;
    private const int PowderItemId  = 186000089;
    private const int KinahCost    = 70000;
    private const int KinahItemId  = 182400001;

    private readonly IItemDao _itemDao;

    public _3963GrowthFlorasThirdCharm(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
