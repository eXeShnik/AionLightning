// Port of Java data/scripts/system/handlers/quest/argent_manor/_30452UndoingSpellweaver.java (Ritsu).
// Talk to the start npc (799535) to accept; kill 217241 (var 0->1); report to 799537 (var 1,
// SET_SUCCEED flips to REWARD); turn in back at 799535.
// Java bug: same harmless START-status fallthrough as quest/argent_manor/_30402TheRescue.cs -
...
public sealed class _30452UndoingSpellweaver : QuestHandlerBase
{
    private const int QuestIdConst = 30452;
    private const int StartNpc     = 799535;
    private const int ReportNpc    = 799537;
    private const int MobNpc       = 217241;

    public _30452UndoingSpellweaver(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
