// Port of Java data/scripts/system/handlers/quest/inggison/_11057StanisSecretOrder.java.
// Item-use start (182206843, removed on accept); kill 296493 (var 0->1), 296494 (var 1->2), then
// 296495 (var 2->reward) in sequence; turn-in at 799043 requires 15,000,000 kinah (decreased on
...
public sealed class _11057StanisSecretOrder : QuestHandlerBase
{
    private const int QuestIdConst = 11057;
    ...
    private const int OrderItem    = 182206843;
    private const int KinahCost    = 15000000;
    private const int KinahItemId  = 182400001;

    private readonly IItemDao _itemDao;

    public _11057StanisSecretOrder(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
