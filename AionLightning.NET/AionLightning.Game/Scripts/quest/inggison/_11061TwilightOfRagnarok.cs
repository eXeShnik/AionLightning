// Port of Java data/scripts/system/handlers/quest/inggison/_11061TwilightOfRagnarok.java.
// Item-use start (182206847, no removal on accept); relay at 799043 (var 0->1); kill 216516 once
// while var==1 flips to reward; turn in back at 799043 removes the item.
...
public sealed class _11061TwilightOfRagnarok : QuestHandlerBase
{
    private const int QuestIdConst = 11061;
    private const int TurnInNpc    = 799043;
    private const int TargetMob    = 216516;
    private const int TokenItem    = 182206847;

    private readonly IItemDao _itemDao;

    public _11061TwilightOfRagnarok(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
