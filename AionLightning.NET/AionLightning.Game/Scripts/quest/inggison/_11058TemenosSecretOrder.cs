// Port of Java data/scripts/system/handlers/quest/inggison/_11058TemenosSecretOrder.java.
// Item-use start (182206844, removed on accept); kill 296493 (var 0->1), 296494 (var 1->2), then
// 296495 (var 2->reward) in sequence; turn-in at 799049 requires 20,000,000 kinah (decreased on
...
public sealed class _11058TemenosSecretOrder : QuestHandlerBase
{
    private const int QuestIdConst = 11058;
    private const int TurnInNpc    = 799049;
    private const int Mob1         = 296493;
    private const int Mob2         = 296494;
    private const int Mob3         = 296495;
    private const int OrderItem    = 182206844;
    private const int KinahCost    = 20000000;
    private const int KinahItemId  = 182400001;

    private readonly IItemDao _itemDao;

    public _11058TemenosSecretOrder(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
