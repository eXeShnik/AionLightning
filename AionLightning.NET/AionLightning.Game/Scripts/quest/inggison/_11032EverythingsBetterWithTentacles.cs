// Port of Java data/scripts/system/handlers/quest/inggison/_11032EverythingsBetterWithTentacles.java.
// Talk to 798959 to start (no item); collect-item check advances var0->1; talking again gives
// 182206726 (var1->2 regardless of give success, matching Java); using that item flips to reward
...
public sealed class _11032EverythingsBetterWithTentacles : QuestHandlerBase
{
    private const int QuestIdConst = 11032;
    private const int StartNpc     = 798959;
    private const int RewardItem   = 182206726;

    private readonly IItemDao _itemDao;

    public _11032EverythingsBetterWithTentacles(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
