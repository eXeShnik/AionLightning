// Port of Java data/scripts/system/handlers/quest/inggison/_11033YouMakeMeSick.java.
// Talk to 798959 to start (no item); collect-item check advances var0->1; talking again gives
// 182206728 (var1->2 regardless of give success, matching Java); using that item flips to reward
...
public sealed class _11033YouMakeMeSick : QuestHandlerBase
{
    private const int QuestIdConst = 11033;
    private const int StartNpc     = 798959;
    private const int RewardItem   = 182206728;

    private readonly IItemDao _itemDao;

    public _11033YouMakeMeSick(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
