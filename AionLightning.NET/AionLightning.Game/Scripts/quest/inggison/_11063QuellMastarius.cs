// Port of Java data/scripts/system/handlers/quest/inggison/_11063QuellMastarius.java.
// Item-use start (182206849, no removal on accept); relay at 799049 (var 0->1); kill 258220 while
// var is in [1,2) advances to var 2; back at 799049 (SET_SUCCEED) gives item 182206850 and flips
// to reward; turn in at 798926 removes both items.
...
public sealed class _11063QuellMastarius : QuestHandlerBase
{
    private const int QuestIdConst = 11063;
    private const int RelayNpc     = 799049;
    private const int TurnInNpc    = 798926;
    private const int TargetMob    = 258220;
    private const int TokenItem    = 182206849;
    private const int ProofItem    = 182206850;

    private readonly IItemDao _itemDao;

    public _11063QuellMastarius(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override async ValueTask<bool> OnKillAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        return await DefaultOnKillEventAsync(env, conn, TargetMob, 1, 2, ct);
    }
}
