// Port of Java data/scripts/system/handlers/quest/inggison/_11105WifesNagging.java.
// Talk to 798948 to start (accept gives item 182206778, ignoring give failure); relay at 798984
// (var 0) swaps 182206778 for 182206779 (var only advances if the give succeeds); turn in at
// 798980 removes 182206779 and flips to reward.
...
public sealed class _11105WifesNagging : QuestHandlerBase
{
    private const int QuestIdConst = 11105;
    private const int StartNpc     = 798948;
    private const int RelayNpc     = 798984;
    private const int TurnInNpc    = 798980;
    private const int Item1        = 182206778;
    private const int Item2        = 182206779;

    private readonly IItemDao _itemDao;

    public _11105WifesNagging(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
