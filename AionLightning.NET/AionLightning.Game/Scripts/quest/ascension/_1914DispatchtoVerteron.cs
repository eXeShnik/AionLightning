// Port of Java data/scripts/system/handlers/quest/ascension/_1914DispatchtoVerteron.java.
...
public sealed class _1914DispatchtoVerteron : QuestHandlerBase
{
    private const int QuestIdConst = 1914;
    private const int OfficerNpc   = 203726;
    private const int ContactNpc   = 203097;

    public _1914DispatchtoVerteron(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
