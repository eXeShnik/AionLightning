// Port of Java data/scripts/system/handlers/quest/ascension/_1913DispatchtoVerteron.java.
...
public sealed class _1913DispatchtoVerteron : QuestHandlerBase
{
    private const int QuestIdConst = 1913;
    private const int OfficerNpc   = 203726;
    private const int ContactNpc   = 203097;

    public _1913DispatchtoVerteron(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
