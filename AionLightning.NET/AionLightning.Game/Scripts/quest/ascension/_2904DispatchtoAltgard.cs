// Port of Java data/scripts/system/handlers/quest/ascension/_2904DispatchtoAltgard.java.
...
public sealed class _2904DispatchtoAltgard : QuestHandlerBase
{
    private const int QuestIdConst = 2904;
    private const int OfficerNpc   = 204191;
    private const int ContactNpc   = 203559;

    public _2904DispatchtoAltgard(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
