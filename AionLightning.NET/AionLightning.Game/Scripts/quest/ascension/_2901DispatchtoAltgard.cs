// Port of Java data/scripts/system/handlers/quest/ascension/_2901DispatchtoAltgard.java.
...
public sealed class _2901DispatchtoAltgard : QuestHandlerBase
{
    private const int QuestIdConst = 2901;
    private const int OfficerNpc   = 204191;
    private const int ContactNpc   = 203559;

    public _2901DispatchtoAltgard(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
