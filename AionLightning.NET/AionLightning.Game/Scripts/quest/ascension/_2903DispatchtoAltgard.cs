// Port of Java data/scripts/system/handlers/quest/ascension/_2903DispatchtoAltgard.java.
...
public sealed class _2903DispatchtoAltgard : QuestHandlerBase
{
    private const int QuestIdConst = 2903;
    private const int OfficerNpc   = 204191;
    private const int ContactNpc   = 203559;

    public _2903DispatchtoAltgard(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
