// Port of Java data/scripts/system/handlers/quest/hero/_23527OldSpiritsOldGrudges.java (Elyos
// mirror of _13527OldSpiritsOldGrudges). Accept at 801949 (starts a 1800s quest timer, no confirm
...
//
// Java bug: the killEvent switch was missing a `break` after case 233304 (same as _13527), so
// killing 233304 also fell through into case 233305's block. Ported here as four independent,
// non-fallthrough kill checks (one var each) instead.
...
public sealed class _23527OldSpiritsOldGrudges : QuestHandlerBase
{
    private const int QuestIdConst  = 23527;
    ...
    public _23527OldSpiritsOldGrudges(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
