// Port of Java data/scripts/system/handlers/quest/hero/_13530AHeroReward.java.
// Auto-starts on level-up (no preceding quest gate); talk to Tirins (800527) to finish immediately —
...
public sealed class _13530AHeroReward : QuestHandlerBase
{
    private const int QuestIdConst = 13530;
    private const int TirinsNpc    = 800527;

    public _13530AHeroReward(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
