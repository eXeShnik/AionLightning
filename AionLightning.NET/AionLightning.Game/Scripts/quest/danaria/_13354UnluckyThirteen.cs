// Port of Java data/scripts/system/handlers/quest/danaria/_13354UnluckyThirteen.java (Romanz).
// Auto-starts on entering Danaria's SAURO_FOOT_PATH_600060000 region (registerOnEnterZone -> QuestService.startQuest);
...
// player.isInsideZone(SAURO_FOOT_PATH_600060000) — no zone-shape infra in this port, so the trigger is broadened to
// "anywhere in the world" like every other kill_in_world port here, e.g. sarpan's
// _11522FurbackHunting); turn in at UnluckyThirteen (801040). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13354UnluckyThirteen : QuestHandlerBase
{
    private const int QuestIdConst   = 13354;
    private const int TurnInNpc      = 801040;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "SAURO_FOOT_PATH_600060000";

    public _13354UnluckyThirteen(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
