// Port of Java data/scripts/system/handlers/quest/danaria/_13359PormeoRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at PormeoRequest (801045). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13359PormeoRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 13359;
    private const int TurnInNpc      = 801045;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "PRADETH_MEADOWS_600060000";

    public _13359PormeoRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
