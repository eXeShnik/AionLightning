// Port of Java data/scripts/system/handlers/quest/danaria/_23352PreydisRequest.java (Romanz).
// Auto-starts on entering Danaria's IDEAN_LAKE_600060000 region (registerOnEnterZone -> QuestService.startQuest);
...
// player.isInsideZone(IDEAN_LAKE_600060000) — no zone-shape infra in this port, so the trigger is broadened to
// "anywhere in the world" like every other kill_in_world port here, e.g. sarpan's
// _11522FurbackHunting); turn in at PreydisRequest (801048). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23352PreydisRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23352;
    private const int TurnInNpc      = 801048;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "IDEAN_LAKE_600060000";

    public _23352PreydisRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
