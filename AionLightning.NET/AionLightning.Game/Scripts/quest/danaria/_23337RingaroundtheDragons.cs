// Port of Java data/scripts/system/handlers/quest/danaria/_23337RingaroundtheDragons.java (Romanz).
// Asmodian counterpart of _13337ItsJustAnArmy with an identical flow; only the start/turn-in NPC
// differs (801053). Accept at 801053 (page 4762 -> ASK_QUEST_ACCEPT page 4 -> QUEST_ACCEPT_1 starts ->
// QUEST_REFUSE_1 page 1004); entering the LDF5B sensory area moves var 0 -> 1, then kill six Balaur
// army mobs (231348-231353) to reach var 10, hand in the collected items (CHECK_USER_HAS_QUEST_ITEM)
// 10 -> 11 flipping to REWARD; turn in at 801053.
...
public sealed class _23337RingaroundtheDragons : QuestHandlerBase
{
    private const int QuestIdConst = 23337;
    private const int StartNpc     = 801053;
    ...
    public _23337RingaroundtheDragons(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
