// Port of Java data/scripts/system/handlers/quest/danaria/_13352CeronRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at CeronRequest (801038). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13352CeronRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 13352;
    private const int TurnInNpc      = 801038;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "IDEAN_LAKE_600060000";

    public _13352CeronRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
