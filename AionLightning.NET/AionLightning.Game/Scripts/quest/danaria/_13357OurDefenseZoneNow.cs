// Port of Java data/scripts/system/handlers/quest/danaria/_13357OurDefenseZoneNow.java (Romanz).
// Auto-starts on entering Danaria's BERITRAN_DEFENSE_ZONE_600060000 region (registerOnEnterZone -> QuestService.startQuest);
...
// player.isInsideZone(BERITRAN_DEFENSE_ZONE_600060000) — no zone-shape infra in this port, so the trigger is broadened to
// "anywhere in the world" like every other kill_in_world port here, e.g. sarpan's
// _11522FurbackHunting); turn in at OurDefenseZoneNow (801043). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13357OurDefenseZoneNow : QuestHandlerBase
{
    private const int QuestIdConst   = 13357;
    private const int TurnInNpc      = 801043;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "BERITRAN_DEFENSE_ZONE_600060000";

    public _13357OurDefenseZoneNow(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
