// Port of Java data/scripts/system/handlers/quest/danaria/_13351StifasRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at StifasRequest (801037). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13351StifasRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 13351;
    private const int TurnInNpc      = 801037;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "SLEEPING_ELDERS_PLATEAU_600060000";

    public _13351StifasRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
