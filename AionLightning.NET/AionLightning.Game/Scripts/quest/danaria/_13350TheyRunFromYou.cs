// Port of Java data/scripts/system/handlers/quest/danaria/_13350TheyRunFromYou.java (Romanz).
// Auto-starts on entering Danaria's TAINTED_LANDS_600060000 region (registerOnEnterZone -> QuestService.startQuest);
...
// player.isInsideZone(TAINTED_LANDS_600060000) — no zone-shape infra in this port, so the trigger is broadened to
// "anywhere in the world" like every other kill_in_world port here, e.g. sarpan's
// _11522FurbackHunting); turn in at TheyRunFromYou (801036). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13350TheyRunFromYou : QuestHandlerBase
{
    private const int QuestIdConst   = 13350;
    private const int TurnInNpc      = 801036;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "TAINTED_LANDS_600060000";

    public _13350TheyRunFromYou(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
