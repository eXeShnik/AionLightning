// Port of Java data/scripts/system/handlers/quest/danaria/_23353TorpinRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at TorpinRequest (801049). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23353TorpinRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23353;
    private const int TurnInNpc      = 801049;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "SILENT_HILLS_600060000";

    public _23353TorpinRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
