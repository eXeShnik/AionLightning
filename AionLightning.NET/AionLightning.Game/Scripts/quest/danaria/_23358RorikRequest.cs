// Port of Java data/scripts/system/handlers/quest/danaria/_23358RorikRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at RorikRequest (801054). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23358RorikRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23358;
    private const int TurnInNpc      = 801054;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "PRADETH_SUPPLY_ROAD_600060000";

    public _23358RorikRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
