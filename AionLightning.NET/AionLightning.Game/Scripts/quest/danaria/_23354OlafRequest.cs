// Port of Java data/scripts/system/handlers/quest/danaria/_23354OlafRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at OlafRequest (801050). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23354OlafRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23354;
    private const int TurnInNpc      = 801050;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "SAURO_FOOT_PATH_600060000";

    public _23354OlafRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
