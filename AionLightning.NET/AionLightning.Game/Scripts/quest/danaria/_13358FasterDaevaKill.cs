// Port of Java data/scripts/system/handlers/quest/danaria/_13358FasterDaevaKill.java (Romanz).
// Auto-starts on entering Danaria's PRADETH_SUPPLY_ROAD_600060000 region (registerOnEnterZone -> QuestService.startQuest);
...
// player.isInsideZone(PRADETH_SUPPLY_ROAD_600060000) — no zone-shape infra in this port, so the trigger is broadened to
// "anywhere in the world" like every other kill_in_world port here, e.g. sarpan's
// _11522FurbackHunting); turn in at FasterDaevaKill (801044). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _13358FasterDaevaKill : QuestHandlerBase
{
    private const int QuestIdConst   = 13358;
    private const int TurnInNpc      = 801044;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "PRADETH_SUPPLY_ROAD_600060000";

    public _13358FasterDaevaKill(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
