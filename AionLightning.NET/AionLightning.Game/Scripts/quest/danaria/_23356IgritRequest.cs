// Port of Java data/scripts/system/handlers/quest/danaria/_23356IgritRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at IgritRequest (801052). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23356IgritRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23356;
    private const int TurnInNpc      = 801052;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "SILONA_FOUNTAINHEAD_600060000";

    public _23356IgritRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
