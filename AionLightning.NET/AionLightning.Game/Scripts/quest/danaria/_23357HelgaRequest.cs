// Port of Java data/scripts/system/handlers/quest/danaria/_23357HelgaRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at HelgaRequest (801053). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23357HelgaRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23357;
    private const int TurnInNpc      = 801053;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "BERITRAN_DEFENSE_ZONE_600060000";

    public _23357HelgaRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
