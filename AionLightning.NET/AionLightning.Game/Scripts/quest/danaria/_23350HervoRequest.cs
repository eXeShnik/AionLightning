// Port of Java data/scripts/system/handlers/quest/danaria/_23350HervoRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at HervoRequest (801046). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23350HervoRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23350;
    private const int TurnInNpc      = 801046;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "TAINTED_LANDS_600060000";

    public _23350HervoRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
