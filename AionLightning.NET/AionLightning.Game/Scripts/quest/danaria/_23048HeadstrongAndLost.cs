// Port of Java data/scripts/system/handlers/quest/danaria/_23048HeadstrongAndLost.java (pralinka).
// Asmodian counterpart of _13048. Accept at 801063. Talking the lost NPC (801278, SETPRO1) makes it
// follow the player to 206322 (var0 0->1); reaching there flips to REWARD (defaultFollowEndEvent 1,1,true).
// Report to 801063. Losing the escort rolls var0 back 1->0. Unblocked by the follow/escort subsystem
...
public sealed class _23048HeadstrongAndLost : QuestHandlerBase
{
    private const int QuestIdConst = 23048;
    private const int StartNpc     = 801063;
    private const int FollowerNpc  = 801278;
    private const int TargetNpc    = 206322;

    public _23048HeadstrongAndLost(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
