// Port of Java data/scripts/system/handlers/quest/danaria/_23355UbeRequest.java (Romanz).
...
// _11522FurbackHunting); turn in at UbeRequest (801051). qs.canRepeat() (daily-reset re-entry) isn't
...
public sealed class _23355UbeRequest : QuestHandlerBase
{
    private const int QuestIdConst   = 23355;
    private const int TurnInNpc      = 801051;
    private const int DanariaWorldId = 600060000;
    private const string EnterZoneName = "DRAINED_BASIN_600060000";

    public _23355UbeRequest(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
