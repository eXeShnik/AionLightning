// Port of Java data/scripts/system/handlers/quest/raksang/_28700_The_Prison_of_Death.java (Cheatkiller).
// Asmodian mirror of _18700Prison_Break_In inside the Raksang dungeon. Start at npc 799266; talk to
// 799439 (SETPRO1 var0 0->1), 799438 (SETPRO2 var0 1->2), destroy the 4 generators (730453/54/55/56,
// var0 2->3), kill 217392 (3->4), talk to 799429 with movie 455 (SETPRO5 4->5), kill the two bosses
// 217425/217451 (5->6), re-enter zone RAKSANG_DUNGEON_CHASM_300310000 (6->7), kill 217764 (7->8),
// kill 217647 (8->9), then talk to 799439 (SET_SUCCEED) to flip REWARD; turn in back at 799266.
// Npc 730468 is registered for talk but unused, preserved from Java.
// Java bug: the Java dialog handler hardcodes the start-npc check to 799532 (the Elyos npc from the
// _18700 copy-paste), but only 799266 is registered as this quest's start npc — so the Asmodian
// quest could never be started or turned in. Fixed here to use the registered start npc 799266.
...
public sealed class _28700The_Prison_of_Death : QuestHandlerBase
{
    private const int QuestIdConst = 28700;
    private const int StartNpc     = 799266;
    ...
    public _28700The_Prison_of_Death(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
