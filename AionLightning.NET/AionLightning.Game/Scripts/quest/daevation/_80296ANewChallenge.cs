// Port of Java data/scripts/system/handlers/quest/daevation/_80296ANewChallenge.java
// (Asmodian mirror of _80292ANewChallenge, same dialog table, NPC 831388, different item ids).
...
public sealed class _80296ANewChallenge : QuestHandlerBase
{
    private const int QuestIdConst        = 80296;
    private const int Npc                 = 831388;
    ...
    [
        110601357, 113601309, 114601306, 112601300, 111601320,
        110301410, 113301375, 114301410, 112301294, 111301351,
        110101514, 113101376, 114101404, 112101313, 111101359,
        110501383, 113501356, 114501364, 112501281, 111501341,
        110301670, 113301639, 114301674, 112301547, 111301608,
    ];

    private readonly IItemDao _itemDao;

    public _80296ANewChallenge(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
