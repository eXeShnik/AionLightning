// Port of Java data/scripts/system/handlers/quest/daevation/_80291DurableDaevanionWeapon.java (Romanz).
// Start and turn in at 831384: hand over the required collect items (CHECK_USER_HAS_QUEST_ITEM,
...
public sealed class _80291DurableDaevanionWeapon : QuestHandlerBase
{
    private const int QuestIdConst = 80291;
    private const int Npc          = 831384;

    private readonly IItemDao _itemDao;

    public _80291DurableDaevanionWeapon(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
