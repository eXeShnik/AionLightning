// Port of Java data/scripts/system/handlers/quest/daevation/_80297NewAdventure.java
// (Asmodian mirror of _80293NewAdventure, same dialog table, NPC 831389, different item ids).
...
public sealed class _80297NewAdventure : QuestHandlerBase
{
    private const int QuestIdConst        = 80297;
    private const int Npc                 = 831389;
    ...
    [
        100001450, 100901123, 101301059, 100201268, 101701158, 100101107, 101501140,
        100601195, 100501114, 115001478, 101801054, 101901004, 102001077, 102100954,
    ];

    private readonly IItemDao _itemDao;

    public _80297NewAdventure(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
