// Port of Java data/scripts/system/handlers/quest/talocs_hollow/_11468WithFriendsLikeThese.java (Cheatkiller).
// Offered at 799526 (OnQuestStart, direct questId dispatch), no items. Using skill 9832 counts var
// 1 up to 10, 9833 counts var 2 up to 5, 9834 counts var 3 up to 3; once all three caps are hit the
// quest flips to REWARD and all three vars reset to 0 (matching Java - the counters are not shown
// again, they only gate the flip). Turn in at 799503.
...
public sealed class _11468WithFriendsLikeThese : QuestHandlerBase
{
    private const int QuestIdConst = 11468;
    ...
    public _11468WithFriendsLikeThese(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
