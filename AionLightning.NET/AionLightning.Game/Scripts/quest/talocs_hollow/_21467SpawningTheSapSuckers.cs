// Port of Java data/scripts/system/handlers/quest/talocs_hollow/_21467SpawningTheSapSuckers.java (Cheatkiller).
// Elyos counterpart of _11467DeathToTheQueen - identical shape, ids, and timer schedule (same npcs
// 799527/799503/215480). Offered at 799527 (OnQuestStart, direct questId dispatch): accepting starts
// an 8min (480s) quest timer. Killing 215480 at any point flips straight to REWARD, picking a reward
// tier from var 0's value at kill time (0/1/2/3 -> reward index 0/1/2/3). While running, the timer
...
public sealed class _21467SpawningTheSapSuckers : QuestHandlerBase
{
    private const int QuestIdConst = 21467;
    private const int StartNpc     = 799527;
    private const int TurnInNpc    = 799503;
    private const int QueenNpc     = 215480;

    public _21467SpawningTheSapSuckers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
