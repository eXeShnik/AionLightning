// Port of Java data/scripts/system/handlers/quest/verteron/_1218NumonerksDemandNote.java
// (MrPoke, Dune11). Talk to the first npc (203121) to start; advance at 798004 (var 0->1); turn
// in at 203172 (flips var to 2, REWARD, regardless of current status besides NONE/COMPLETE).
using System.Linq;
...
public sealed class _1218NumonerksDemandNote : QuestHandlerBase
{
    private const int QuestIdConst = 1218;
    private const int FirstNpc     = 203121;
    private const int SecondNpc    = 798004;
    private const int ThirdNpc     = 203172;

    public _1218NumonerksDemandNote(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override async ValueTask<bool> OnDialogAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
    {
        ...
        if (targetId == ThirdNpc && entry is not null)
        {
