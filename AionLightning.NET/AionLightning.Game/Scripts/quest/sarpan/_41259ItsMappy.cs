// Port of Java data/scripts/system/handlers/quest/sarpan/_41259ItsMappy.java (Cheatkiller).
// Started by using a map fragment item (182213108, no NPC involved) - accepting hands in the
// fragment at Devena (800127, var 0->1), giving a finished map (182213151) and a marker item
// (182213188); using the finished map spawns a delivery point (730478) at the player's position and
...
public sealed class _41259ItsMappy : QuestHandlerBase
{
    private const int QuestIdConst  = 41259;
    private const int FragmentItemId = 182213108;
    private const int MapItemId      = 182213151;
    private const int MarkerItemId   = 182213188;
    private const int DevenaNpc      = 800127;
    private const int DeliveryPointNpc = 730478;

    private readonly IItemDao _itemDao;

    public _41259ItsMappy(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
