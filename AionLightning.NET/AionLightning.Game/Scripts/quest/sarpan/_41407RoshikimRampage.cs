// Port of Java data/scripts/system/handlers/quest/sarpan/_41407RoshikimRampage.java (Cheatkiller).
// Auto-start/complete: engaging mob 282922 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41407RoshikimRampage : QuestHandlerBase
{
    private const int QuestIdConst = 41407;
    private const int MobId        = 282922;

    public _41407RoshikimRampage(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
