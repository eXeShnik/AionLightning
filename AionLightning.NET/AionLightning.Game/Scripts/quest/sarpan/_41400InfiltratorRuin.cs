// Port of Java data/scripts/system/handlers/quest/sarpan/_41400InfiltratorRuin.java (Cheatkiller).
// Auto-start/complete: engaging mob 282913 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41400InfiltratorRuin : QuestHandlerBase
{
    private const int QuestIdConst = 41400;
    private const int MobId        = 282913;

    public _41400InfiltratorRuin(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
