// Port of Java data/scripts/system/handlers/quest/sarpan/_41408SatrakandSkirmish.java (Cheatkiller).
// Auto-start/complete: engaging mob 282919 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41408SatrakandSkirmish : QuestHandlerBase
{
    private const int QuestIdConst = 41408;
    private const int MobId        = 282919;

    public _41408SatrakandSkirmish(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
