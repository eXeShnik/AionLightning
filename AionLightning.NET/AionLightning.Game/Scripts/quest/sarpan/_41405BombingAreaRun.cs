// Port of Java data/scripts/system/handlers/quest/sarpan/_41405BombingAreaRun.java (Cheatkiller).
// Auto-start/complete: engaging mob 282918 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41405BombingAreaRun : QuestHandlerBase
{
    private const int QuestIdConst = 41405;
    private const int MobId        = 282918;

    public _41405BombingAreaRun(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
