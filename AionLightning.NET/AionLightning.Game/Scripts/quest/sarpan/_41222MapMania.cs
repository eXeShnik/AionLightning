// Port of Java data/scripts/system/handlers/quest/sarpan/_41222MapMania.java (Cheatkiller).
// Started by using a map fragment item (182213105, no NPC involved) - accepting hands in the
// fragment at Devena (800127, var 0->1), giving a finished map (182213150) and a marker item
// (182213187); using the finished map spawns a delivery point (730475) at the player's position and
...
public sealed class _41222MapMania : QuestHandlerBase
{
    private const int QuestIdConst  = 41222;
    private const int FragmentItemId = 182213105;
    private const int MapItemId      = 182213150;
    private const int MarkerItemId   = 182213187;
    private const int DevenaNpc      = 800127;
    private const int DeliveryPointNpc = 730475;

    private readonly IItemDao _itemDao;

    public _41222MapMania(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
