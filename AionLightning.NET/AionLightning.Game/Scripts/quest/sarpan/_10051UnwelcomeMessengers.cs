// Port of Java data/scripts/system/handlers/quest/sarpan/_10051UnwelcomeMessengers.java (vlog).
// Talk to Kutos (205581) to start; Killios (205535) var 1->2; Philmoni (205765) var 2->3, then
...
public sealed class _10051UnwelcomeMessengers : QuestHandlerBase
{
    private const int QuestIdConst   = 10051;
    ...
    public _10051UnwelcomeMessengers(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
    ...
    public override ValueTask<bool> OnLevelUpAsync(QuestEnv env, GsClientConnection conn, CancellationToken ct)
        => DefaultOnLvlUpEventAsync(env, conn, precedingQuestId: 10050, isZoneMission: true, ct);
