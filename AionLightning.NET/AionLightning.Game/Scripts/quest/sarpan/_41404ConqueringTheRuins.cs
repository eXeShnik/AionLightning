// Port of Java data/scripts/system/handlers/quest/sarpan/_41404ConqueringTheRuins.java (Cheatkiller).
// Auto-start/complete: engaging mob 282916 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41404ConqueringTheRuins : QuestHandlerBase
{
    private const int QuestIdConst = 41404;
    private const int MobId        = 282916;

    public _41404ConqueringTheRuins(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
