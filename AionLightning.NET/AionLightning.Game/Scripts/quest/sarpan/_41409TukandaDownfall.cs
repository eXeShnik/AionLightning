// Port of Java data/scripts/system/handlers/quest/sarpan/_41409TukandaDownfall.java (Cheatkiller).
// Auto-start/complete: engaging mob 282921 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41409TukandaDownfall : QuestHandlerBase
{
    private const int QuestIdConst = 41409;
    private const int MobId        = 282921;

    public _41409TukandaDownfall(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
