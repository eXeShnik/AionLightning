// Port of Java data/scripts/system/handlers/quest/sarpan/_41410EndingTheInvasion.java (Cheatkiller).
// Auto-start/complete: engaging mob 282923 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41410EndingTheInvasion : QuestHandlerBase
{
    private const int QuestIdConst = 41410;
    private const int MobId        = 282923;

    public _41410EndingTheInvasion(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
