// Port of Java data/scripts/system/handlers/quest/sarpan/_41402ShowdownWithUshaba.java (Cheatkiller).
// Auto-start/complete: engaging mob 282917 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41402ShowdownWithUshaba : QuestHandlerBase
{
    private const int QuestIdConst = 41402;
    private const int MobId        = 282917;

    public _41402ShowdownWithUshaba(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
