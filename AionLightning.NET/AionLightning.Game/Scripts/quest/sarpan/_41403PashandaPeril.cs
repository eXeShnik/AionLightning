// Port of Java data/scripts/system/handlers/quest/sarpan/_41403PashandaPeril.java (Cheatkiller).
// Auto-start/complete: engaging mob 282915 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41403PashandaPeril : QuestHandlerBase
{
    private const int QuestIdConst = 41403;
    private const int MobId        = 282915;

    public _41403PashandaPeril(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
