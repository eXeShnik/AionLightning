// Port of Java data/scripts/system/handlers/quest/sarpan/_41401ShinadyGans.java (Cheatkiller).
// Auto-start/complete: engaging mob 282914 starts the quest, killing it finishes it (reward index 0).
...
public sealed class _41401ShinadyGans : QuestHandlerBase
{
    private const int QuestIdConst = 41401;
    private const int MobId        = 282914;

    public _41401ShinadyGans(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
