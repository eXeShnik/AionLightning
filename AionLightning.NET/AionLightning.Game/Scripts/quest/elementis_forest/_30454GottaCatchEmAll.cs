// Port of Java data/scripts/system/handlers/quest/elementis_forest/_30454GottaCatchEmAll.java (Ritsu).
...
// 1->2 and REWARD; turn in at 205575 (not the start npc). Identical structure to
// _30404ASpiritualConsultation - a different quest_data.xml collect-item/reward set, same npcs.
...
public sealed class _30454GottaCatchEmAll : QuestHandlerBase
{
    private const int QuestIdConst = 30454;
    private const int StartNpc     = 799551;
    private const int SeerNpc      = 205575;

    private readonly IItemDao _itemDao;

    public _30454GottaCatchEmAll(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
