// Port of Java data/scripts/system/handlers/quest/theobomos/_3035EnhancingtheStone.java.
// Talk to Atropos (798155) to start; report to two middle npcs (203830 then 279029) in
...
public sealed class _3035EnhancingtheStone : QuestHandlerBase
{
    private const int QuestIdConst = 3035;
    private const int AtroposNpc   = 798155;
    private const int MiddleNpc1   = 203830;
    private const int MiddleNpc2   = 279029;

    public _3035EnhancingtheStone(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
