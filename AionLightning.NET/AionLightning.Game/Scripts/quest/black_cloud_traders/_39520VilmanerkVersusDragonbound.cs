// Port of Java data/scripts/system/handlers/quest/black_cloud_traders/_39520VilmanerkVersusDragonbound.java
// (Cheatkiller). Structurally identical to _39505BackbitingBotheration (see that file's header for
// the documented Npc.getController().onDelete() skip): kill one of 8 mobs for a 20% chance to spawn
// the relay npc 205984; talk to it (var 0->1), then to 205885 to flip to REWARD and turn in.
using System;
...
public sealed class _39520VilmanerkVersusDragonbound : QuestHandlerBase
{
    private const int QuestIdConst = 39520;
    private const int FinalNpc     = 205885;
    private const int RelayNpc     = 205984;

    private static readonly int[] Mobs = [218387, 218389, 218391, 218393, 218395, 218397, 218399, 218401];

    public _39520VilmanerkVersusDragonbound(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
