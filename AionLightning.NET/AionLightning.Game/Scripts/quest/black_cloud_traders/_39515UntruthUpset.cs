// Port of Java data/scripts/system/handlers/quest/black_cloud_traders/_39515UntruthUpset.java
// (Cheatkiller). Structurally identical to _39505BackbitingBotheration (see that file's header for
// the documented Npc.getController().onDelete() skip): kill one of 5 mobs for a 20% chance to spawn
// the relay npc 701154; talk to it (var 0->1), then to 205884 to flip to REWARD and turn in.
using System;
...
public sealed class _39515UntruthUpset : QuestHandlerBase
{
    private const int QuestIdConst = 39515;
    private const int FinalNpc     = 205884;
    private const int RelayNpc     = 701154;

    private static readonly int[] Mobs = [218307, 218309, 218311, 218313, 218315];

    public _39515UntruthUpset(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
