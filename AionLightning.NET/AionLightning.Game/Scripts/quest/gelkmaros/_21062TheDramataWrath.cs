// Port of Java data/scripts/system/handlers/quest/gelkmaros/_21062TheDramataWrath.java (Cheatkiller).
// Item-use quest: using item 182207851 opens the accept dialog (page 4); talk to 799354 (var 0->1);
// kill 218756 while at var 1 flips to REWARD; turn in at 799354 (removes the item).
...
public sealed class _21062TheDramataWrath : QuestHandlerBase
{
    private const int QuestIdConst = 21062;
    private const int NpcId        = 799354;
    private const int MobId        = 218756;
    private const int ItemId       = 182207851;

    private readonly IItemDao _itemDao;

    public _21062TheDramataWrath(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
