// Port of Java data/scripts/system/handlers/quest/gelkmaros/_21125MysteryBlueprint.java (Cheatkiller).
// Item-use quest: using the Mystery Blueprint (182207865) opens the accept dialog (page 4); turn
// in at 799295, which removes the blueprint on the actual reward turn-in.
...
public sealed class _21125MysteryBlueprint : QuestHandlerBase
{
    private const int QuestIdConst = 21125;
    private const int NpcId        = 799295;
    private const int ItemId       = 182207865;

    private readonly IItemDao _itemDao;

    public _21125MysteryBlueprint(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
