// Port of Java data/scripts/system/handlers/quest/gelkmaros/_21061NewOrder.java (Cheatkiller).
// Item-use quest: using item 182207850 opens the accept dialog (page 4); talk to 799360 (var 0->1);
// kill 216516 while at var 1 flips to REWARD; turn in at 799360 (removes the item).
...
public sealed class _21061NewOrder : QuestHandlerBase
{
    private const int QuestIdConst = 21061;
    private const int NpcId        = 799360;
    private const int MobId        = 216516;
    private const int ItemId       = 182207850;

    private readonly IItemDao _itemDao;

    public _21061NewOrder(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
