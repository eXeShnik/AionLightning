// Port of Java data/scripts/system/handlers/quest/gelkmaros/_21221RustyRelic.java (Cheatkiller).
// Item-use quest: using the Rusty Relic (182207878) opens the accept dialog (page 4); relay at
// 799239 (SETPRO1 forces var->1, reward flip); turn in at 799320 (removes the item).
...
public sealed class _21221RustyRelic : QuestHandlerBase
{
    private const int QuestIdConst = 21221;
    private const int RelayNpc     = 799239;
    private const int FinalNpc     = 799320;
    private const int ItemId       = 182207878;

    private readonly IItemDao _itemDao;

    public _21221RustyRelic(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
