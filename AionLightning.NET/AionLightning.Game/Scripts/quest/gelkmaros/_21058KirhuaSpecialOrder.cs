// Port of Java data/scripts/system/handlers/quest/gelkmaros/_21058KirhuaSpecialOrder.java (Cheatkiller).
// Item-use quest: using item 182207847 removes it and starts the quest directly (no accept
// dialog). Kill chain 296489 (var 0->1) -> 296490 (var 1->2) -> 296491 (var 2, reward). Turn in
// at 799360: paying 20,000,000 kinah unlocks the real reward page; otherwise shows the
...
public sealed class _21058KirhuaSpecialOrder : QuestHandlerBase
{
    private const int QuestIdConst = 21058;
    private const int NpcId        = 799360;
    private const int ItemId       = 182207847;
    private const int KinahItemId  = 182400001;
    private const long KinahCost   = 20000000;
    private static readonly int[] MobIds = [296489, 296490, 296491];

    private readonly IItemDao _itemDao;

    public _21058KirhuaSpecialOrder(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
