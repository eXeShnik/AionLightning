// Port of Java data/scripts/system/handlers/quest/aturam_sky_fortress/_18303Making_A_Sur.java (zhkchi).
// Talk to 799530 to start (plays movie 470 on accept); talk to 730390 (SETPRO1 teleports the player
// to world 300240000 @158.88,624.42,901); use quest object 700980 (var2->3, dieObject); kill
// 217382 then 217376 (var0 0->1->2); turn in at 799531.
...
public sealed class _18303Making_A_Sur : QuestHandlerBase
{
    private const int QuestIdConst = 18303;
    ...
    public _18303Making_A_Sur(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
