// Port of Java data/scripts/system/handlers/quest/heiron/_1605TheLepharistSituation.java.
// Talk to the start NPC (204576); advance at 204530 (var 0->1, generic page 10), then at 204501
// (var 1->2, page 1693); turn in at 204577 (var ->3, REWARD).
...
public sealed class _1605TheLepharistSituation : QuestHandlerBase
{
    private const int QuestIdConst = 1605;
    private const int StartNpc     = 204576;
    private const int MidNpcOne    = 204530;
    private const int MidNpcTwo    = 204501;
    private const int EndNpc       = 204577;

    public _1605TheLepharistSituation(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
