// Port of Java data/scripts/system/handlers/quest/pernon/_28821YourButlerGift.java (Rolandas, Bobobear).
// Talk to any of 5 butler-template npcs (810022-810026) to start (repeatable — canRepeat() is
// approximated as "no active entry", the same simplification used across other zones since this
...
// migration_plan.md housing gap), so that ownership gate is omitted; any of the 5 butler npc
...
public sealed class _28821YourButlerGift : QuestHandlerBase
{
    private const int QuestIdConst = 28821;

    private static readonly HashSet<int> Butlers = [810022, 810023, 810024, 810025, 810026];

    public _28821YourButlerGift(IDataManager dataManager, IQuestDao questDao, QuestRewardService rewardService, IItemDao itemDao)
